...
!
program test_fp16_sum
    use lpf_fp16
    use iso_fortran_env, only: real32, real64
    use lpf_fp16_test_utils
    implicit none

    print *, "Running tests for fp16_sum..."
    ...
    print *, "All fp16_sum tests passed!"
...
contains
    ...
    subroutine test_sum_1d()
        ...
        res = sum(vec)
        ref_res = sum(ref_vec)
        call check_fp16_real64('sum_1d', res, real(ref_res, real64) , FP16_TOL)
    end subroutine
    ...
    subroutine test_sum_2d()
        ...
        call check_fp16_real64('sum_2d', res, real(ref_res, real64) , FP16_TOL)
    end subroutine
    ...
    subroutine test_sum_3d()
        ...
        res = sum(vec)
        ref_res = sum(ref_vec)
        call check_fp16_real64('sum_3d', res, real(ref_res, real64) , FP16_TOL)
    end subroutine
    ...
    subroutine test_sum_2d_dim()
        ...
        do i = 1, 2
            call check_fp16_real64('sum_2d_dim1_' // integer_to_char(i), res_dim1(i), real(ref_dim1(i), real64) &
                & , FP16_TOL)
        end do
        ...
        do i = 1, 2
            call check_fp16_real64('sum_2d_dim2_' // integer_to_char(i), res_dim2(i), real(ref_dim2(i), real64) &
                & , FP16_TOL)
        end do
    end subroutine
    ...
    subroutine test_sum_3d_dim()
        ...
        do j = 1, 2
            do i = 1, 2
                call check_fp16_real64('sum_3d_dim1_' // trim(integer_to_char(i)) // '_' &
        ...
        do j = 1, 2
            do i = 1, 2
                call check_fp16_real64('sum_3d_dim2_' // trim(integer_to_char(i)) // '_' // integer_to_char(j), &
        ...
        do j = 1, 2
            do i = 1, 2
                call check_fp16_real64('sum_3d_dim3_' // trim(integer_to_char(i)) // '_' &
    ...
    subroutine test_sum_mask()
        ...
        call check_fp16_real64('sum_mask_1d', res, real(ref_res, real64), FP16_TOL)
    end subroutine
    ...
    subroutine test_sum_edge_cases()
        ...
        call check_fp16_real64('sum_edge_single', res, real(ref_res, real64), FP16_TOL)

        ! Array with zero
        res = sum([FP16(1.5), FP16(0.0), FP16(2.0)])
        ref_res = sum([1.5_real32, 0.0_real32, 2.0_real32])
        call check_fp16_real64('sum_edge_zero', res, real(ref_res, real64), FP16_TOL)

        ! Array with negative numbers
        res = sum([FP16(-1.5), FP16(-2.0), FP16(0.5)])
        ref_res = sum([-1.5_real32, -2.0_real32, 0.5_real32])
        call check_fp16_real64('sum_edge_neg', res, real(ref_res, real64), FP16_TOL)

        ! Scalar mask - all true
        res = sum([FP16(1.5), FP16(2.0)], mask=.TRUE.)
        ref_res = sum([1.5_real32, 2.0_real32])
        call check_fp16_real64('sum_edge_mask_T', res, real(ref_res, real64), FP16_TOL)

        ! Scalar mask - all false
        res = sum([FP16(1.5), FP16(2.0)], mask=.FALSE.)
        ref_res = 0.0_real32
        call check_fp16_real64('sum_edge_mask_F', res, real(ref_res, real64), FP16_TOL)
    end subroutine

end program test_fp16_sum

...
CONTAINS
    ...
    subroutine test_add()
        ...
        call check_fp16_real64('add_fp16_real64',  FP16(2.0_real32) + 3.0_real64, 5.0_real64, FP16_TOL)
        call check_fp16_real64('add_real64_fp16',  3.0_real64 + FP16(2.0_real32), 5.0_real64, FP16_TOL)
    ...
    subroutine test_subtract()
        ...
        call check_fp16_real64('sub_fp16_real64', FP16(5.0_real32) - 3.0_real64, 2.0_real64, FP16_TOL)
        call check_fp16_real64('sub_real64_fp16', 5.0_real64 - FP16(3.0_real32), 2.0_real64, FP16_TOL)
    ...
    subroutine test_multiply()
        ...
        call check_fp16_real64('mul_fp16_real64', FP16(4.0_real32) * 3.0_real64, 12.0_real64, FP16_TOL)
        call check_fp16_real64('mul_real64_fp16', 4.0_real64 * FP16(3.0_real32), 12.0_real64, FP16_TOL)
    ...
    subroutine test_divide()
        ...
        call check_fp16_real64('div_fp16_real64', FP16(10.0_real32) / 2.0_real64, 5.0_real64, FP16_TOL)
        call check_fp16_real64('div_real64_fp16', 10.0_real64 / FP16(2.0_real32), 5.0_real64, FP16_TOL)
    ...
    subroutine test_power()
        ...
        call check_fp16_real64('pow_fp16_real64', FP16(2.0_real32) ** 3.0_real64, 8.0_real64, FP16_TOL)

...
CONTAINS
    ...
    SUBROUTINE run_tests()
        ...
        y(1, 1) = BF16(4.0_real32)
        y(2, 1) = BF16(5.0_real32)
        y(3, 1) = BF16(6.0_real32)

        ! Test Case 2: Positive and negative values
        x(1, 2) = BF16(1.0_real32)
        x(2, 2) = BF16(-2.0_real32)
        x(3, 2) = BF16(3.0_real32)
        x(4, 2) = BF16(-4.0_real32)
        y(1, 2) = BF16(1.0_real32)
        y(2, 2) = BF16(1.0_real32)
        y(3, 2) = BF16(1.0_real32)
        y(4, 2) = BF16(1.0_real32)

        ! Test Case 3: Including zeros
        x(1, 3) = BF16(0.0_real32)
        x(2, 3) = BF16(1.0_real32)
        x(3, 3) = BF16(0.0_real32)
        x(4, 3) = BF16(-1.0_real32)
        x(5, 3) = BF16(2.0_real32)
        y(1, 3) = BF16(1.0_real32)
        y(2, 3) = BF16(0.0_real32)
        y(3, 3) = BF16(1.0_real32)
        y(4, 3) = BF16(1.0_real32)
        y(5, 3) = BF16(1.0_real32)

        ! Test Case 4: Precision test (more elements)
        do i = 1, 10
            x(i, 4) = BF16(real(1, real32))
            y(i, 4) = BF16(real(i, real32)/10.0)
        end do
        ...
        do i = 1, NTEST
            ...
            CALL check_bf16_real64('dot_product case ' // trim(integer_to_char(i)), &
                                  result, real(ref_result, real64), BF16_TOL)
        end do
    end SUBROUTINE
END PROGRAM test_bf16_dot_product

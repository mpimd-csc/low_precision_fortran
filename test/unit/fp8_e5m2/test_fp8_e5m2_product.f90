...
!
program test_fp8_e5m2_product
    use lpf_fp8_e5m2
    use iso_fortran_env, only: real32, real64
    use lpf_fp8_e5m2_test_utils
    implicit none

    print *, "Running tests for fp8_e5m2_product..."
    ...
    print *, "All fp8_e5m2_product tests passed!"
...
contains
    ...
    subroutine test_product_1d()
        ...
        call check_fp8_e5m2_real64('product_1d', res, real(ref_res, real64) , FP8_E5M2_TOL)
    end subroutine
    ...
    subroutine test_product_2d()
        ...
        call check_fp8_e5m2_real64('product_2d', res, real(ref_res, real64) , FP8_E5M2_TOL)
    end subroutine
    ...
    subroutine test_product_3d()
        ...
        res = product(vec)
        ref_res = product(ref_vec)
        call check_fp8_e5m2_real64('product_3d', res, real(ref_res, real64) , FP8_E5M2_TOL)
    end subroutine
    ...
    subroutine test_product_2d_dim()
        ...
        do i = 1, 2
            call check_fp8_e5m2_real64('product_2d_dim1_' // integer_to_char(i), res_dim1(i), real(ref_dim1(i), real64) &
                & , FP8_E5M2_TOL)
        end do
        ...
        do i = 1, 2
            call check_fp8_e5m2_real64('product_2d_dim2_' // integer_to_char(i), res_dim2(i), real(ref_dim2(i), real64) &
                & , FP8_E5M2_TOL)
        end do
    end subroutine
    ...
    subroutine test_product_3d_dim()
        ...
        do j = 1, 2
            do i = 1, 2
                call check_fp8_e5m2_real64('product_3d_dim1_' // trim(integer_to_char(i)) // '_' &
        ...
        do j = 1, 2
            do i = 1, 2
                call check_fp8_e5m2_real64('product_3d_dim2_' // trim(integer_to_char(i)) // '_' // integer_to_char(j), &
        ...
        do j = 1, 2
            do i = 1, 2
                call check_fp8_e5m2_real64('product_3d_dim3_' // trim(integer_to_char(i)) // '_' &
    ...
    subroutine test_product_mask()
        ...
        call check_fp8_e5m2_real64('product_mask_1d', res, real(ref_res, real64), FP8_E5M2_TOL)
    end subroutine
    ...
    subroutine test_product_edge_cases()
        ...
        ! Single element
        res = product([FP8_E5M2(1.5)])
        ref_res = product([1.5_real32])
        call check_fp8_e5m2_real64('product_edge_single', res, real(ref_res, real64), FP8_E5M2_TOL)

        ! Array with zero
        res = product([FP8_E5M2(1.5), FP8_E5M2(0.0), FP8_E5M2(2.0)])
        ref_res = product([1.5_real32, 0.0_real32, 2.0_real32])
        call check_fp8_e5m2_real64('product_edge_zero', res, real(ref_res, real64), FP8_E5M2_TOL)

        ! Array with negative numbers
        res = product([FP8_E5M2(-1.5), FP8_E5M2(-2.0), FP8_E5M2(0.5)])
        ref_res = product([-1.5_real32, -2.0_real32, 0.5_real32])
        call check_fp8_e5m2_real64('product_edge_neg', res, real(ref_res, real64), FP8_E5M2_TOL)

        ! Scalar mask - all true
        res = product([FP8_E5M2(1.5), FP8_E5M2(2.0)], mask=.TRUE.)
        ref_res = product([1.5_real32, 2.0_real32])
        call check_fp8_e5m2_real64('product_edge_mask_T', res, real(ref_res, real64), FP8_E5M2_TOL)

        ! Scalar mask - all false
        res = product([FP8_E5M2(1.5), FP8_E5M2(2.0)], mask=.FALSE.)
        ref_res = 1.0_real32
        call check_fp8_e5m2_real64('product_edge_mask_F', res, real(ref_res, real64), FP8_E5M2_TOL)
    end subroutine

end program test_fp8_e5m2_product

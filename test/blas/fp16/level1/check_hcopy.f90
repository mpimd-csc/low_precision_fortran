...
CONTAINS
    ...
    SUBROUTINE run_tests(ok)
        ...
        ! Expected results
        expected(1, 1) = FP16(1.0_real32)
        expected(2, 1) = FP16(-2.0_real32)
        expected(3, 1) = FP16(3.0_real32)
        expected(4, 1) = FP16(-4.0_real32)
        expected(5, 1) = FP16(5.0_real32)
        ...
        expected(1, 3) = FP16(3.0_real32)
        expected(2, 3) = FP16(-4.0_real32)
        ...
        expected(1, 4) = FP16(1.0_real32)
        expected(2, 4) = FP16(3.0_real32)
        expected(3, 4) = FP16(-1.0_real32)
        expected(4, 4) = FP16(0.0_real32)
        expected(5, 4) = FP16(1.0_real32)
        expected(6, 4) = FP16(0.0_real32)
        expected(7, 4) = FP16(-1.0_real32)
        expected(8, 4) = FP16(0.0_real32)
        expected(9, 4) = FP16(0.0_real32)
        expected(10, 4) = FP16(0.0_real32)
        expected(1, 5) = FP16(10.0_real32)
        expected(2, 5) = FP16(-4.0_real32)
        expected(3, 5) = FP16(0.399902_real32)
        ...
        expected(2, 6) = FP16(0.0_real32)
        expected(3, 6) = FP16(9.0_real32)
        expected(4, 6) = FP16(0.0_real32)

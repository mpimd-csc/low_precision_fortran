...
int16_t LPF_GLOBAL(hasum,HASUM)(lpf_blas_int_t *, lpf_float16_t *, lpf_blas_int_t *);
...
#define NTEST 6
    ...
    lpf_float16_t hasum_expected[NTEST] = {15, 7.5, 0, 4.0, 10, 0};

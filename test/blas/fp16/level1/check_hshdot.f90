...
CONTAINS
    ...
    SUBROUTINE run_tests(ok)
        ...
        expected(1) = FP16(55.0_real32) + b
        expected(2) = FP16(20.75_real32) + b
        expected(3) = FP16(-5.0_real32) + b
        expected(4) = FP16(-3.0_real32) + b
        expected(5) = FP16(1.599609_real32) + b
        expected(6) = FP16(243.0_real32) + b
        expected(7) = FP16(6.0_real32) + b
        expected(8) = b

...
lpf_blas_int_t LPF_GLOBAL(ihamax,IHAMAX)(lpf_blas_int_t *, lpf_float16_t *, lpf_blas_int_t *);

// Testfunktion check_hnrm2
void check_ihamax( bool *ok) {
#define NTEST 6
    ...
    lpf_blas_int_t ihamax_expected[NTEST] = {3, 2, 1, 1, 1, 0};

...
CONTAINS
    ...
    SUBROUTINE run_tests(ok)
        ...
        xresult(1, 1) = FP16(0.779785_real32)
        ...
        xresult(:, 2) = xresult(:, 1)
        xresult(1, 3) = FP16(0.779785_real32)
        xresult(2, 3) = FP16(-0.459961_real32)
        ...
        xresult(1, 4) = FP16(0.779785_real32)
        xresult(2, 4) = FP16(0.099976_real32)
        xresult(3, 4) = FP16(-0.219849_real32)
        xresult(4, 4) = FP16(0.799805_real32)
        xresult(5, 4) = FP16(0.359619_real32)
        xresult(6, 4) = FP16(-0.300049_real32)
        xresult(7, 4) = FP16(0.160156_real32)
        xresult(8, 4) = FP16(0.0_real32)
        xresult(9, 4) = FP16(0.0_real32)
        xresult(10, 4) = FP16(0.0_real32)
        xresult(:, 5) = xresult(:, 1)
        xresult(:, 6) = xresult(:, 1)
        xresult(1, 7) = FP16(0.779785_real32)
        xresult(2, 7) = FP16(-0.459961_real32)
        xresult(3, 7) = FP16(-0.219849_real32)
        ...
        xresult(1, 8) = FP16(0.779785_real32)
        xresult(2, 8) = FP16(-0.459961_real32)
        xresult(3, 8) = FP16(-0.219849_real32)
        xresult(4, 8) = FP16(1.059570_real32)
        xresult(5, 8) = FP16(0.359619_real32)
        xresult(6, 8) = FP16(-0.119995_real32)
        xresult(7, 8) = FP16(0.160156_real32)
        xresult(8, 8) = FP16(0.0_real32)
        xresult(9, 8) = FP16(0.0_real32)
        xresult(10, 8) = FP16(0.0_real32)

        yresult(1, 1) = FP16(0.039795_real32)
        ...
        yresult(:, 2) = yresult(:, 1)
        yresult(1, 3) = FP16(0.039795_real32)
        yresult(2, 3) = FP16(-0.779785_real32)
        ...
        yresult(1, 4) = FP16(0.039795_real32)
        yresult(2, 4) = FP16(-0.899902_real32)
        yresult(3, 4) = FP16(0.540039_real32)
        yresult(4, 4) = FP16(0.700195_real32)
        yresult(5, 4) = FP16(-1.019531_real32)
        yresult(6, 4) = FP16(0.199951_real32)
        yresult(7, 4) = FP16(0.879883_real32)
        yresult(8, 4) = FP16(0.0_real32)
        yresult(9, 4) = FP16(0.0_real32)
        yresult(10, 4) = FP16(0.0_real32)
        yresult(:, 5) = yresult(:, 1)
        yresult(:, 6) = yresult(:, 1)
        yresult(1, 7) = FP16(0.039795_real32)
        yresult(2, 7) = FP16(-0.779785_real32)
        yresult(3, 7) = FP16(0.540039_real32)
        ...
        yresult(1, 8) = FP16(0.039795_real32)
        yresult(2, 8) = FP16(-0.779785_real32)
        yresult(3, 8) = FP16(0.540039_real32)
        yresult(4, 8) = FP16(0.080078_real32)
        yresult(5, 8) = FP16(-1.019531_real32)
        yresult(6, 8) = FP16(0.340088_real32)
        yresult(7, 8) = FP16(0.879883_real32)

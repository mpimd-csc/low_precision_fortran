...
contains
    ...
    subroutine test_typical(uplo, trans, diag)
        ...
        call tbsv(uplo, trans, diag, n, k, a, k+1, x, incx)

        do i = 1, 3
            call check_dt_real64("tbsv_typical_" // uplo // trans // diag, int(i,int64), x(i), dble(x_old(i)), GENERIC_TOL)
        end do
    ...
    subroutine test_edge()
        ...
        call tbsv('U', 'N', 'N', n, k, a, k+1, x, incx)
    end subroutine
    ...
    subroutine test_stride(uplo, trans, diag)
        ...
        do i = 1, 5
            call check_dt_real64("tbsv_stride_" // uplo // trans // diag, int(i,int64), x(i), dble(x_old(i)), GENERIC_TOL)
        end do

    end subroutine

end program test_level2_tbsv

...
CONTAINS
    ...
    SUBROUTINE run_tests(ok)
        ...
        y(1, 6) = BF16(0.0_real32)
        y(2, 6) = BF16(0.0_real32)
        y(3, 6) = BF16(0.0_real32)
        y(4, 6) = BF16(0.0_real32)
        y(5, 6) = BF16(0.0_real32)
        y(6, 6) = BF16(-9.0_real32)
        y(7, 6) = BF16(-9.0_real32)
        y(8, 6) = BF16(-9.0_real32)
        y(9, 6) = BF16(-9.0_real32)
        y(10, 6) = BF16(-9.0_real32)

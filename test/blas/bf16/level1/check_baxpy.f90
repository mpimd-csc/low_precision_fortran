...
CONTAINS
    ...
    SUBROUTINE run_tests(ok)
        ...
        expected(1, 2) = BF16(4.5_real32)
        expected(2, 2) = BF16(-7.5_real32)
        expected(3, 2) = BF16(10.5_real32)
        ...
        expected(1, 3) = BF16(5.242188_real32)
        expected(2, 3) = BF16(-3.656250_real32)
        expected(3, 3) = BF16(-1.0_real32)
        expected(4, 3) = BF16(2.0_real32)
        ...
        expected(1, 5) = BF16(-9.0_real32)
        expected(2, 5) = BF16(6.0_real32)
        expected(3, 5) = BF16(-1.400391_real32)

...
int16_t LPF_GLOBAL(bsbdot,BSBDOT)(lpf_blas_int_t *, lpf_bfloat16_t *, lpf_bfloat16_t *, lpf_blas_int_t *, lpf_bfloat16_t *, lpf_blas_int_t *);
...
#define NTEST 8
    ...
    lpf_bfloat16_t hsbdot_expected[NTEST] = {55 + b , 20.75 + b , -5 + b, -3 + b, 1.599609f + b, 243 + b, 6 + b, b};

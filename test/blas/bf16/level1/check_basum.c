...
int16_t LPF_GLOBAL(basum,BASUM)(lpf_blas_int_t *, lpf_bfloat16_t *, lpf_blas_int_t *);
...
#define NTEST 6
    ...
    lpf_bfloat16_t basum_expected[NTEST] = {15, 7.5, 0, 4.0, 10, 0};

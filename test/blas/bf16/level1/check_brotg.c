...
void LPF_GLOBAL(brotg,BROTG)(lpf_bfloat16_t *sa, lpf_bfloat16_t *sb, lpf_bfloat16_t *sc, lpf_bfloat16_t *ss);


void check_brotg(bool *ok)
{
#define NTEST 8
    lpf_bfloat16_t SA, SB, SC, SS;
    lpf_blas_int_t i;

    lpf_bfloat16_t DA1[NTEST] = {0.3f, 0.4f, -0.3f, -0.4f, -0.3f, 0.0f, 0.0f, 1.0f};
    lpf_bfloat16_t DB1[NTEST] = {0.4f, 0.3f, 0.4f, 0.3f, -0.4f, 0.0f, 1.0f, 0.0f};
    lpf_bfloat16_t DC1[NTEST] = {0.6f, 0.8f, -0.6f, 0.8f, 0.6f, 1.0f, 0.0f, 1.0f};
    lpf_bfloat16_t DS1[NTEST] = {0.8f, 0.6f, 0.8f, -0.6f, 0.8f, 0.0f, 1.0f, 0.0f};
    lpf_bfloat16_t DATRUE[NTEST] = {0.5f, 0.5f, 0.5f, -0.5f, -0.5f, 0.0f, 1.0f, 1.0f};
    lpf_bfloat16_t DBTRUE[NTEST] = {1.0f/0.6f, 0.6f, -1.0f/0.6f, -0.6f, 1.0f/0.6f, 0.0f, 1.0f, 0.0f};

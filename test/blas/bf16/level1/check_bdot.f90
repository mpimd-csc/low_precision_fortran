...
CONTAINS
    ...
    SUBROUTINE run_tests(ok)
        ...
        expected(1) = BF16(55.0_real32)
        expected(2) = BF16(20.75_real32)
        expected(3) = BF16(-5.0_real32)
        expected(4) = BF16(-3.0_real32)
        expected(5) = BF16(1.599609_real32)
        expected(6) = BF16(243.0_real32)
        expected(7) = BF16(6.0_real32)
        expected(8) = BF16(0.0_real32)

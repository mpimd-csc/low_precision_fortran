...
CONTAINS
    ...
    SUBROUTINE run_tests(ok)
        ...
        TYPE(BF16), dimension(NTEST) :: alpha
        TYPE(BF16), dimension(NTEST) :: beta
        ...
        ! Alpha values
        alpha(1) = BF16(1.0_real32)
        alpha(2) = BF16(2.0_real32)
        alpha(3) = BF16(sqrt(2.0_real32))
        alpha(4) = BF16(0.0_real32)
        alpha(5) = BF16(-1.0_real32)
        alpha(6) = BF16(-2.0_real32)
        alpha(7) = BF16(0.0_real32)
        alpha(8) = BF16(2.0_real32)

        ! Beta values
        beta(1) = BF16(1.0_real32)
        beta(2) = BF16(-1.0_real32)
        beta(3) = BF16(0.0_real32)
        beta(4) = BF16(1.0_real32)
        beta(5) = BF16(-1.0_real32)
        beta(6) = BF16(0.0_real32)
        beta(7) = BF16(1.0_real32)
        beta(8) = BF16(-1.0_real32)
        ...
        ! Expected results
        expected(1, 1) = BF16(2.0_real32)
        expected(2, 1) = BF16(-4.0_real32)
        expected(3, 1) = BF16(6.0_real32)
        expected(4, 1) = BF16(-8.0_real32)
        expected(5, 1) = BF16(10.0_real32)
        ...
        expected(1, 3) = BF16(4.242188_real32)
        expected(2, 3) = BF16(-5.656250_real32)
        ...
        expected(1, 4) = BF16(0.0_real32)
        expected(2, 4) = BF16(3.0_real32)
        expected(3, 4) = BF16(3.0_real32)
        expected(4, 4) = BF16(0.0_real32)
        expected(5, 4) = BF16(0.0_real32)
        expected(6, 4) = BF16(0.0_real32)
        expected(7, 4) = BF16(0.0_real32)
        expected(8, 4) = BF16(0.0_real32)
        expected(9, 4) = BF16(0.0_real32)
        expected(10, 4) = BF16(0.0_real32)
        expected(1, 5) = BF16(-11.0_real32)
        expected(2, 5) = BF16(2.0_real32)
        expected(3, 5) = BF16(0.600098_real32)
        expected(4, 5) = BF16(-2.0_real32)
        ...
        expected(1, 6) = BF16(-18.0_real32)
        expected(2, 6) = BF16(9.0_real32)
        expected(3, 6) = BF16(-18.0_real32)
        expected(4, 6) = BF16(9.0_real32)
        expected(5, 6) = BF16(-18.0_real32)

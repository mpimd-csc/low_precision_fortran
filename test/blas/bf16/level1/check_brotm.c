...
void LPF_GLOBAL(brotm,BROTM)(lpf_blas_int_t *, lpf_bfloat16_t *, lpf_blas_int_t *, lpf_bfloat16_t *, lpf_blas_int_t *, lpf_bfloat16_t *);

void check_brotm( bool *ok) {
#define NTEST 8
    ...
    for ( int i = 0; i < NTEST; i++) {
        ...
        LPF_GLOBAL(brotm, BROTM)(&n[i], xtemp, &incx[i], ytemp, &incy[i], partemp );

...
!> BGEMM  T PUT F FOR NO TEST. SAME COLUMNS.
!> BSYMM  T PUT F FOR NO TEST. SAME COLUMNS.
!> BTRMM  T PUT F FOR NO TEST. SAME COLUMNS.
!> BTRSM  T PUT F FOR NO TEST. SAME COLUMNS.
!> BSYRK  T PUT F FOR NO TEST. SAME COLUMNS.
...
!     .. Local Arrays ..
      TYPE(BF16)               AA( NMAX*NMAX ), AB( NMAX, 2*NMAX ),           &
...
!     .. Data statements ..
      DATA               SNAMES/'BGEMM', 'BSYMM  ', 'BTRMM  ',          &
     &                   'BTRSM  ', 'BSYRK  ', 'BSYR2K ', 'BGEMMTR'/
...
!
 ...
 9995 FORMAT( ' TESTS OF THE TYPE(BF16)             LEVEL 3 BLAS', //' THE F',&
...
!     .. Scalar Arguments ..
      ...
      CHARACTER*7        SNAME
!     .. Array Arguments ..
      TYPE(BF16)               AA( NMAX*NMAX ), AB( 2*NMAX*NMAX ),            &

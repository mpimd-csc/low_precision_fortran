#ifndef LPF_FP8_E4M3_TLAPACK_HPP
#define LPF_FP8_E4M3_TLAPACK_HPP
...
namespace tlapack {
    ...
    namespace traits {
        ...
        template <>
            struct real_type_traits<lpf_fp8_e4m3_t, int> {
                using type = lpf_fp8_e4m3_t;
                constexpr static bool is_real = true;
            };
        // The complex type of mpfr::mpreal is std::complex<mpfr::mpreal>
        template <>
            struct complex_type_traits<lpf_fp8_e4m3_t, int> {
                using type = std::complex<lpf_fp8_e4m3_t>;
    ...
    template <>
        inline int digits<lpf_fp8_e4m3_t>() noexcept
        {

...
MODULE LPF_BF16
    ...
    INTERFACE ASSIGNMENT(=)
        ...
        module procedure assign_to_double, assign_to_int
    END INTERFACE
    ...
    interface operator(.lt.)
        module procedure lt_bf16_bf16, lt_bf16_real32, lt_real32_bf16
        module procedure lt_bf16_real64, lt_real64_bf16
    end interface operator(.lt.)

    ! .le. operator
    interface operator(.le.)
        module procedure le_bf16_bf16, le_bf16_real32, le_real32_bf16
        module procedure le_bf16_real64, le_real64_bf16
    end interface operator(.le.)

    ! .gt. operator
    interface operator(.gt.)
        module procedure gt_bf16_bf16, gt_bf16_real32, gt_real32_bf16
        module procedure gt_bf16_real64, gt_real64_bf16
    end interface operator(.gt.)

    ! .ge. operator
    interface operator(.ge.)
        module procedure ge_bf16_bf16, ge_bf16_real32, ge_real32_bf16
        module procedure ge_bf16_real64, ge_real64_bf16
    end interface operator(.ge.)

    ! .eq. operator
    interface operator(.eq.)
        module procedure eq_bf16_bf16, eq_bf16_real32, eq_real32_bf16
        module procedure eq_bf16_real64, eq_real64_bf16
    end interface operator(.eq.)

    ! .ne. operator
    interface operator(.ne.)
        module procedure ne_bf16_bf16, ne_bf16_real32, ne_real32_bf16
        module procedure ne_bf16_real64, ne_real64_bf16
    ...
    interface product
        module pure function bf16_product_r1(vec, mask) result(out)
            type(bf16), intent(in) :: vec(:)
            logical, intent(in), optional :: mask(..)
            type(bf16) :: out
        end function

        module pure function bf16_product_r2(vec, mask) result(out)
            type(bf16), intent(in) :: vec(:,:)
            logical, intent(in), optional :: mask(..)
            type(bf16) :: out
        end function

        module pure function bf16_product_r3(vec, mask) result(out)
            type(bf16), intent(in) :: vec(:,:,:)
            logical, intent(in), optional :: mask(..)
            type(bf16) :: out
        end function

        module pure function bf16_product_r1_dim(vec, dim, mask) result(out)
            type(bf16), intent(in) :: vec(:)
            integer, intent(in) :: dim
            logical, intent(in), optional :: mask(..)
            type(bf16) :: out
        ...
        module pure function bf16_product_r2_dim(vec, dim, mask) result(out)
            type(bf16), intent(in) :: vec(:, :)
            integer, intent(in) :: dim
            logical, intent(in), optional :: mask(..)
        ...
        module pure function bf16_product_r3_dim(vec, dim, mask) result(out)
            type(bf16), intent(in) :: vec(:, :, :)
            integer, intent(in) :: dim
            logical, intent(in), optional :: mask(..)
    ...
    interface sum
        module pure function bf16_sum_r1(vec, mask) result(out)
            type(bf16), intent(in) :: vec(:)
            logical, intent(in), optional :: mask(..)
            type(bf16) :: out
        end function

        module pure function bf16_sum_r2(vec, mask) result(out)
            type(bf16), intent(in) :: vec(:,:)
            logical, intent(in), optional :: mask(..)
            type(bf16) :: out
        end function

        module pure function bf16_sum_r3(vec, mask) result(out)
            type(bf16), intent(in) :: vec(:,:,:)
            logical, intent(in), optional :: mask(..)
            type(bf16) :: out
        end function

        module pure function bf16_sum_r1_dim(vec, dim, mask) result(out)
            type(bf16), intent(in) :: vec(:)
            integer, intent(in) :: dim
            logical, intent(in), optional :: mask(..)
            type(bf16) :: out
        ...
        module pure function bf16_sum_r2_dim(vec, dim, mask) result(out)
            type(bf16), intent(in) :: vec(:, :)
            integer, intent(in) :: dim
            logical, intent(in), optional :: mask(..)
            type(bf16), dimension(size(vec,merge(2, 1, dim == 1))) :: out
        ...
        module pure function bf16_sum_r3_dim(vec, dim, mask) result(out)
            type(bf16), intent(in) :: vec(:, :, :)
            integer, intent(in) :: dim
            logical, intent(in), optional :: mask(..)
            type(bf16), dimension( size(vec, merge(2, 1, dim == 1)), &
    ...
    ! C Interfaces
    INTERFACE
        PURE SUBROUTINE SET_BF16_FROM_INT(OUT, IN) BIND(C, name = "__bf16_helper_set_from_int")
            USE, INTRINSIC:: iso_c_binding
            INTEGER(c_int16_t), INTENT(OUT) :: OUT
            INTEGER(c_int), VALUE, INTENT(IN) :: IN
        END SUBROUTINE
        PURE SUBROUTINE SET_BF16_FROM_REAL(OUT, IN) BIND(C, name = "__bf16_helper_set_from_float")
            USE, INTRINSIC:: iso_c_binding
            INTEGER(c_int16_t), INTENT(OUT) :: OUT
            REAL(c_float), VALUE, INTENT(IN) :: IN
        END SUBROUTINE
        PURE SUBROUTINE SET_BF16_FROM_DOUBLE(OUT, IN) BIND(C, name = "__bf16_helper_set_from_double")
            USE, INTRINSIC:: iso_c_binding
            INTEGER(c_int16_t), INTENT(OUT) :: OUT
            REAL(c_double), VALUE, INTENT(IN) :: IN
        END SUBROUTINE
        PURE REAL(c_float) FUNCTION GET_BF16(IN) BIND(C, name = "__bf16_helper_get_float")
            USE, INTRINSIC :: iso_c_binding
            INTEGER(c_int16_t), INTENT(IN), VALUE :: IN
        END FUNCTION

        pure subroutine helper_add_bf16_bf16(out, a, b) bind(c, name = "__bf16_helper_add_bf16_bf16")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: a
            integer(c_int16_t), intent(in), value :: b
        end subroutine
        pure subroutine helper_add_bf16_real(out, a, b) bind(c, name = "__bf16_helper_add_bf16_real")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: a
        ...
        pure subroutine helper_add_bf16_real64(out, a, b) bind(c, name = "__bf16_helper_add_bf16_real64")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: a
        ...
        pure subroutine helper_mul_bf16_bf16(out, a, b) bind(c, name = "__bf16_helper_mul_bf16_bf16")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: a
            integer(c_int16_t), intent(in), value :: b
        ...
        pure subroutine helper_mul_bf16_real(out, a, b) bind(c, name = "__bf16_helper_mul_bf16_real")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: a
            real(c_float), intent(in), value :: b
        ...
        pure subroutine helper_mul_bf16_real64(out, a, b) bind(c, name = "__bf16_helper_mul_bf16_real64")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: a
            real(c_double), intent(in), value :: b
        ...
        pure subroutine helper_sub_bf16_bf16(out, a, b) bind(c, name = "__bf16_helper_sub_bf16_bf16")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: a
            integer(c_int16_t), intent(in), value :: b
        ...
        pure subroutine helper_sub_bf16_real(out, a, b) bind(c, name = "__bf16_helper_sub_bf16_real")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: a
            real(c_float), intent(in), value :: b
        ...
        pure subroutine helper_sub_real_bf16(out, a, b) bind(c, name = "__bf16_helper_sub_real_bf16")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
        ...
        pure subroutine helper_sub_bf16_real64(out, a, b) bind(c, name = "__bf16_helper_sub_bf16_real64")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: a
            real(c_double), intent(in), value :: b
        ...
        pure subroutine helper_sub_real64_bf16(out, a, b) bind(c, name = "__bf16_helper_sub_real64_bf16")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
        ...
        pure subroutine helper_div_bf16_real(out, a, b) bind(c, name = "__bf16_helper_div_bf16_real")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: a
            real(c_float), intent(in), value :: b
        ...
        pure subroutine helper_div_real_bf16(out, a, b) bind(c, name = "__bf16_helper_div_real_bf16")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            real(c_float), intent(in), value :: a
            integer(c_int16_t), intent(in), value :: b
        ...
        pure subroutine helper_div_bf16_real64(out, a, b) bind(c, name = "__bf16_helper_div_bf16_real64")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: a
            real(c_double), intent(in), value :: b
        ...
        pure subroutine helper_div_real64_bf16(out, a, b) bind(c, name = "__bf16_helper_div_real64_bf16")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            real(c_double), intent(in), value :: a
            integer(c_int16_t), intent(in), value :: b
        ...
        pure subroutine helper_power_bf16_bf16(out, a, b) bind(c, name = "__bf16_helper_pow_bf16_bf16")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: a
            integer(c_int16_t), intent(in), value :: b
        ...
        pure subroutine helper_power_bf16_real(out, a, b) bind(c, name = "__bf16_helper_pow_bf16_real")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: a
            real(c_float), intent(in), value :: b
        ...
        pure subroutine helper_power_bf16_int(out, a, b) bind(c, name = "__bf16_helper_pow_bf16_int")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: a
...
CONTAINS
    ...
    elemental function construct_real(in) result(r)
        ...
        type(bf16) :: r
        call SET_BF16_FROM_REAL(r%value, in)
    end function
    ...
    elemental subroutine assign_to_double(this, that)
        ...
        type(bf16), intent(in) :: that
        this = real(get_bf16(that%value), real64)
    end subroutine

    elemental subroutine assign_to_int(this, that)
        integer, intent(out) :: this
        type(bf16), intent(in) :: that
        this = int(real(get_bf16(that%value)))
    end subroutine
    ...
    elemental function int_bf16(x) result (out)
        type(bf16), intent(in) :: x
        integer :: out
        out = int(real(get_bf16(x%value)))
    end function
    ...
    ! Operator(+)
    !
    elemental function add_bf16_bf16(this, that) result(sum)
        type(bf16), intent(in) :: this
        type(bf16), intent(in) :: that
        type(bf16) :: sum

        call helper_add_bf16_bf16(sum%value, this%value, that%value)
    end function

    elemental function add_bf16_real(this, that) result(sum)
        type(bf16), intent(in) :: this
        real(real32), intent(in) :: that
        type(bf16) :: sum
        call helper_add_bf16_real(sum%value, this%value, that)
    end function

    elemental function add_real_bf16(this, that) result(sum)
        real(real32), intent(in) :: this
        type(bf16), intent(in) :: that
        type(bf16) :: sum
        call helper_add_bf16_real(sum%value, that%value, this)
    end function

    elemental function add_bf16_real64(this, that) result(sum)
        type(bf16), intent(in) :: this
        real(real64), intent(in) :: that
        type(bf16) :: sum
        call helper_add_bf16_real64(sum%value, this%value, that)
    end function

    elemental function add_real64_bf16(this, that) result(sum)
        real(real64), intent(in) :: this
        type(bf16), intent(in) :: that
        type(bf16) :: sum
        call helper_add_bf16_real64(sum%value, that%value, this)
    end function
    ...
    ! Operator (-)
    !
    elemental function subtract_bf16_bf16(this, that) result(diff)
        type(bf16), intent(in) :: this
        type(bf16), intent(in) :: that
        type(bf16) :: diff

        call helper_sub_bf16_bf16(diff%value, this%value, that%value)
    end function

    elemental function subtract_bf16_real(this, that) result(diff)
        type(bf16), intent(in) :: this
        real(real32), intent(in) :: that
        type(bf16) :: diff

        call helper_sub_bf16_real(diff%value, this%value, that)
    end function

    elemental function subtract_real_bf16(this, that) result(diff)
        real(real32), intent(in) :: this
        type(bf16), intent(in) :: that
        type(bf16) :: diff
    ...
    elemental function subtract_bf16_real64(this, that) result(diff)
        type(bf16), intent(in) :: this
        real(real64), intent(in) :: that
        type(bf16) :: diff

        call helper_sub_bf16_real64(diff%value, this%value, that)
    end function

    elemental function subtract_real64_bf16(this, that) result(diff)
        real(real64), intent(in) :: this
        type(bf16), intent(in) :: that
        type(bf16) :: diff

        call helper_sub_real64_bf16(diff%value, this, that%value)
    end function
    ...
    ! Operator(*)
    !
    elemental function multiply_bf16_bf16(this, that) result(prod)
        type(bf16), intent(in) :: this
        type(bf16), intent(in) :: that
        type(bf16) :: prod

        call helper_mul_bf16_bf16(prod%value, this%value, that%value)
    end function

    elemental function multiply_bf16_real(this, that) result(prod)
        type(bf16), intent(in) :: this
        real(real32), intent(in) :: that
        type(bf16) :: prod

        call helper_mul_bf16_real(prod%value, this%value, that)
    end function

    elemental function multiply_real_bf16(this, that) result(prod)
        real(real32), intent(in) :: this
        type(bf16), intent(in) :: that
        type(bf16) :: prod

        call helper_mul_bf16_real(prod%value, that%value, this)
    end function

    elemental function multiply_bf16_real64(this, that) result(prod)
        type(bf16), intent(in) :: this
        real(real64), intent(in) :: that
        type(bf16) :: prod

        call helper_mul_bf16_real64(prod%value, this%value, that)
    end function

    elemental function multiply_real64_bf16(this, that) result(prod)
        real(real64), intent(in) :: this
        type(bf16), intent(in) :: that
        type(bf16) :: prod

        call helper_mul_bf16_real64(prod%value, that%value, this)
    end function
    ...
    ! Operator(/)
    !
    elemental function divide_bf16_bf16(this, that) result(quot)
        type(bf16), intent(in) :: this
        type(bf16), intent(in) :: that
        type(bf16) :: quot

        call helper_div_bf16_bf16(quot%value, this%value, that%value)
    end function

    elemental function divide_bf16_real(this, that) result(quot)
        type(bf16), intent(in) :: this
        real(real32), intent(in) :: that
        type(bf16) :: quot
    ...
    elemental function divide_real_bf16(this, that) result(quot)
        real(real32), intent(in) :: this
        type(bf16), intent(in) :: that
        type(bf16) :: quot

        call helper_div_real_bf16(quot%value, this, that%value)
    end function

    elemental function divide_bf16_real64(this, that) result(quot)
        type(bf16), intent(in) :: this
        real(real64), intent(in) :: that
        type(bf16) :: quot
        call helper_div_bf16_real64(quot%value, this%value, that)
    end function

    elemental function divide_real64_bf16(this, that) result(quot)
        real(real64), intent(in) :: this
        type(bf16), intent(in) :: that
        type(bf16) :: quot

        call helper_div_real64_bf16(quot%value, this, that%value)
    end function
    ...
    ! Operator (.lt.)
    !
    elemental function lt_bf16_bf16(x, y) result(out)
        type(bf16), intent(in)  :: x
        type(bf16), intent(in) :: y
        logical :: out
    ...
    elemental function lt_bf16_real32(x, y) result(out)
        type(bf16), intent(in)   :: x
    ...
    elemental function lt_real32_bf16(x, y) result(out)
        type(bf16), intent(in)  :: y
    ...
    elemental function lt_bf16_real64(x, y) result(out)
        type(bf16), intent(in)   :: x
    ...
    elemental function lt_real64_bf16(x, y) result(out)
        type(bf16), intent(in)  :: y
    ...
    ! Operator (.le.)
    !
    elemental function le_bf16_bf16(x, y) result(out)
        type(bf16), intent(in)  :: x
        type(bf16), intent(in) :: y
        logical :: out
    ...
    elemental function le_bf16_real32(x, y) result(out)
        type(bf16), intent(in)   :: x
        real(real32), intent(in) :: y
        logical :: out
    ...
    elemental function le_real32_bf16(x, y) result(out)
        type(bf16), intent(in)  :: y
        real(real32), intent(in) :: x
        logical :: out
    ...
    elemental function le_bf16_real64(x, y) result(out)
        type(bf16), intent(in)   :: x
        real(real64), intent(in) :: y
        logical :: out
    ...
    elemental function le_real64_bf16(x, y) result(out)
        type(bf16), intent(in)  :: y
        real(real64), intent(in) :: x
        logical :: out
    ...
    ! Operator (.gt.)
    !
    elemental function gt_bf16_bf16(x, y) result(out)
        type(bf16), intent(in)  :: x
        type(bf16), intent(in) :: y
        logical :: out
    ...
    elemental function gt_bf16_real32(x, y) result(out)
        type(bf16), intent(in)   :: x
        real(real32), intent(in) :: y
        logical :: out
    ...
    elemental function gt_real32_bf16(x, y) result(out)
        type(bf16), intent(in)  :: y
        real(real32), intent(in) :: x
        logical :: out
    ...
    elemental function gt_bf16_real64(x, y) result(out)
        type(bf16), intent(in)   :: x
        real(real64), intent(in) :: y
        logical :: out
    ...
    elemental function gt_real64_bf16(x, y) result(out)
        type(bf16), intent(in)  :: y
        real(real64), intent(in) :: x
        logical :: out
    ...
    ! Operator (.ge.)
    !
    elemental function ge_bf16_bf16(x, y) result(out)
        type(bf16), intent(in)  :: x
        type(bf16), intent(in) :: y
        logical :: out
    ...
    elemental function ge_bf16_real32(x, y) result(out)
        type(bf16), intent(in)   :: x
        real(real32), intent(in) :: y
        logical :: out
    ...
    elemental function ge_real32_bf16(x, y) result(out)
        type(bf16), intent(in)  :: y
        real(real32), intent(in) :: x
        logical :: out
    ...
    elemental function ge_bf16_real64(x, y) result(out)
        type(bf16), intent(in)   :: x
        real(real64), intent(in) :: y
        logical :: out
    ...
    elemental function ge_real64_bf16(x, y) result(out)
        type(bf16), intent(in)  :: y
        real(real64), intent(in) :: x
        logical :: out
    ...
    ! Operator (.eq.)
    !
    elemental function eq_bf16_bf16(x, y) result(out)
        type(bf16), intent(in)  :: x
        type(bf16), intent(in) :: y
        logical :: out
    ...
    elemental function eq_bf16_real32(x, y) result(out)
        type(bf16), intent(in)   :: x
        real(real32), intent(in) :: y
        logical :: out
    ...
    elemental function eq_real32_bf16(x, y) result(out)
        type(bf16), intent(in)  :: y
        real(real32), intent(in) :: x
        logical :: out
    ...
    elemental function eq_bf16_real64(x, y) result(out)
        type(bf16), intent(in)   :: x
        real(real64), intent(in) :: y
        logical :: out
    ...
    elemental function eq_real64_bf16(x, y) result(out)
        type(bf16), intent(in)  :: y
        real(real64), intent(in) :: x
        logical :: out
    ...
    ! Operator (.ne.)
    !
    elemental function ne_bf16_bf16(x, y) result(out)
        type(bf16), intent(in)  :: x
        type(bf16), intent(in) :: y
        logical :: out
    ...
    elemental function ne_bf16_real32(x, y) result(out)
        type(bf16), intent(in)   :: x
        real(real32), intent(in) :: y
        logical :: out
    ...
    elemental function ne_real32_bf16(x, y) result(out)
        type(bf16), intent(in)  :: y
        real(real32), intent(in) :: x
        logical :: out
    ...
    elemental function ne_bf16_real64(x, y) result(out)
        type(bf16), intent(in)   :: x
        real(real64), intent(in) :: y
        logical :: out
    ...
    elemental function ne_real64_bf16(x, y) result(out)
        type(bf16), intent(in)  :: y
        real(real64), intent(in) :: x
        logical :: out
    ...
    ! Operator(**)
    !
    elemental function power_bf16_bf16(this, that) result(power)
        type(bf16), intent(in) :: this
        type(bf16), intent(in) :: that
        type(bf16) :: power

        call helper_power_bf16_bf16(power%value, this%value, that%value)
    end function

    elemental function power_bf16_real(this, that) result(power)
        type(bf16), intent(in) :: this
        real(real32), intent(in) :: that
        type(bf16) :: power

        call helper_power_bf16_real(power%value, this%value, that)
    end function

    elemental function power_bf16_real64(this, that) result(power)
        type(bf16), intent(in) :: this
        real(real64), intent(in) :: that
        type(bf16) :: power
        real(real32) :: e
        ...
        e = real(that, real32)
        call helper_power_bf16_real(power%value, this%value, e)
    end function

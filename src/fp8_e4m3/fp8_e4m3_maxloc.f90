...
contains
    ...
    end function maxloc_fp8_e4m3_2d
    ...
    end function maxloc_fp8_e4m3_3d
    ...
    end function maxloc_fp8_e4m3_4d
    ...
    module pure function maxloc_fp8_e4m3_1d_dim(array, dim) result(max_loc)
        ...
        max_loc = maxloc_fp8_e4m3_1d(array)
    end function maxloc_fp8_e4m3_1d_dim
    ...
    end function maxloc_fp8_e4m3_2d_dim
    ...
    end function maxloc_fp8_e4m3_3d_dim
    ...
    end function maxloc_fp8_e4m3_4d_dim

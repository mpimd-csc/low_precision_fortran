...
submodule (lpf_fp8_e4m3) lpf_fp8_e4m3_maxval
    use iso_c_binding
...
contains
    ...
    end function maxval_fp8_e4m3_1d
    ...
    end function maxval_fp8_e4m3_2d
    ...
    end function maxval_fp8_e4m3_3d
    ...
    end function maxval_fp8_e4m3_4d
    ...
    module pure function maxval_fp8_e4m3_1d_dim(array, dim) result(max_value)
        ...
        max_value = maxval_fp8_e4m3_1d(array)
    end function maxval_fp8_e4m3_1d_dim
    ...
    end function maxval_fp8_e4m3_2d_dim
    ...
    end function maxval_fp8_e4m3_3d_dim
    ...
    end function maxval_fp8_e4m3_4d_dim

...
submodule (lpf_fp8_e4m3) lpf_fp8_e4m3_minloc
    use iso_c_binding
...
contains
    ...
    end function minloc_fp8_e4m3_1d
    ...
    end function minloc_fp8_e4m3_2d
    ...
    end function minloc_fp8_e4m3_3d
    ...
    end function minloc_fp8_e4m3_4d
    ...
    module pure function minloc_fp8_e4m3_1d_dim(array, dim) result(min_loc)
        ...
        min_loc = minloc_fp8_e4m3_1d(array)
    end function minloc_fp8_e4m3_1d_dim
    ...
    end function minloc_fp8_e4m3_2d_dim
    ...
    end function minloc_fp8_e4m3_3d_dim
    ...
    end function minloc_fp8_e4m3_4d_dim

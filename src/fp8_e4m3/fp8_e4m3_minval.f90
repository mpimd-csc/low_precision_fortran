...
submodule (lpf_fp8_e4m3) lpf_fp8_e4m3_minval
    use iso_c_binding
...
contains
    ...
    end function minval_fp8_e4m3_1d
    ...
    end function minval_fp8_e4m3_2d
    ...
    end function minval_fp8_e4m3_3d
    ...
    end function minval_fp8_e4m3_4d
    ...
    module pure function minval_fp8_e4m3_1d_dim(array, dim) result(min_value)
        ...
        min_value = minval_fp8_e4m3_1d(array)
    end function minval_fp8_e4m3_1d_dim
    ...
    end function minval_fp8_e4m3_2d_dim
    ...
    end function minval_fp8_e4m3_3d_dim
    ...
    end function minval_fp8_e4m3_4d_dim

submodule (fp16_support) fp16_math_one_arg
    ...
    interface
        subroutine helper_fp16_acos(out, in) bind(c, name="__fp16_helper_acos")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_acosh(out, in) bind(c, name="__fp16_helper_acosh")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_asin(out, in) bind(c, name="__fp16_helper_asin")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_asinh(out, in) bind(c, name="__fp16_helper_asinh")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_atan(out, in) bind(c, name="__fp16_helper_atan")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_atanh(out, in) bind(c, name="__fp16_helper_atanh")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_bessel_j0(out, in) bind(c, name="__fp16_helper_bessel_j0")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_bessel_j1(out, in) bind(c, name="__fp16_helper_bessel_j1")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_bessel_y0(out, in) bind(c, name="__fp16_helper_bessel_y0")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_bessel_y1(out, in) bind(c, name="__fp16_helper_bessel_y1")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_ceiling(out, in) bind(c, name="__fp16_helper_ceiling")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_cos(out, in) bind(c, name="__fp16_helper_cos")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_cosh(out, in) bind(c, name="__fp16_helper_cosh")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_erf(out, in) bind(c, name="__fp16_helper_erf")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_erfc(out, in) bind(c, name="__fp16_helper_erfc")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_exp(out, in) bind(c, name="__fp16_helper_exp")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_floor(out, in) bind(c, name="__fp16_helper_floor")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_gamma(out, in) bind(c, name="__fp16_helper_gamma")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_log(out, in) bind(c, name="__fp16_helper_log")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_log10(out, in) bind(c, name="__fp16_helper_log10")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_log_gamma(out, in) bind(c, name="__fp16_helper_log_gamma")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_sin(out, in) bind(c, name="__fp16_helper_sin")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_sinh(out, in) bind(c, name="__fp16_helper_sinh")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_sqrt(out, in) bind(c, name="__fp16_helper_sqrt")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_tan(out, in) bind(c, name="__fp16_helper_tan")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine
        subroutine helper_fp16_tanh(out, in) bind(c, name="__fp16_helper_tanh")
            use, intrinsic :: iso_c_binding
            integer(c_int16_t), intent(out) :: out
            integer(c_int16_t), intent(in), value :: in
        end subroutine

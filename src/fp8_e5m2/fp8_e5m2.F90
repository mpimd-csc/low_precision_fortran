...
MODULE LPF_FP8_E5M2
    ...
    interface digits
        module elemental function digits_fp8_e5m2(x) result(abs_val)
            type(FP8_E5M2), intent(in) :: x
            integer :: abs_val
    ...
    interface epsilon
        module elemental function epsilon_fp8_e5m2(x) result(abs_val)
            type(FP8_E5M2), intent(in) :: x
            type(FP8_E5M2) :: abs_val
    ...
    interface isinf
        module elemental function isinf_fp8_e5m2(x) result(out)
            type(FP8_E5M2), intent(in) :: x
            logical :: out
        end function isinf_fp8_e5m2
    end interface

    interface min
        module procedure min_fp8_e5m2
        module procedure min3_fp8_e5m2
    end interface min

    interface max
        module procedure max_fp8_e5m2
        module procedure max3_fp8_e5m2
    end interface max
    ...
    interface minval
        ...
        module pure function minval_fp8_e5m2_1d_dim(array, dim) result(min_value)
            type(fp8_e5m2), dimension(:), intent(in) :: array
            integer, intent(in) :: dim
            type(fp8_e5m2) :: min_value
        end function
        module pure function minval_fp8_e5m2_2d_dim(array, dim) result(min_value)
            type(fp8_e5m2), dimension(:,:), intent(in) :: array
            integer, intent(in) :: dim
            type(fp8_e5m2), dimension(size(array, merge(2, 1, dim == 1))) :: min_value
        end function
        module pure function minval_fp8_e5m2_3d_dim(array, dim) result(min_value)
            type(fp8_e5m2), dimension(:,:,:), intent(in) :: array
            integer, intent(in) :: dim
            type(fp8_e5m2), dimension( size(array, merge(2, 1, dim == 1)), &
                & size(array, merge(2, 3, dim == 3))) :: min_value
        end function
        module pure function minval_fp8_e5m2_4d_dim(array, dim) result(min_value)
            type(fp8_e5m2), dimension(:,:,:,:), intent(in) :: array
            integer, intent(in) :: dim
            type(fp8_e5m2), dimension( size(array, merge(2, 1, dim == 1)), &
                & size(array, merge(3, 2, dim < 3)), &
    ...
    interface maxloc
        module pure function maxloc_fp8_e5m2_1d(array) result(max_loc)
            type(fp8_e5m2), dimension(:), intent(in) :: array
            integer :: max_loc
        end function
        module pure function maxloc_fp8_e5m2_2d(array) result(max_loc)
            type(fp8_e5m2), dimension(:,:), intent(in) :: array
            integer, dimension(2) :: max_loc
        end function
        module pure function maxloc_fp8_e5m2_3d(array) result(max_loc)
            type(fp8_e5m2), dimension(:,:,:), intent(in) :: array
            integer, dimension(3) :: max_loc
        end function
        module pure function maxloc_fp8_e5m2_4d(array) result(max_loc)
            type(fp8_e5m2), dimension(:,:,:,:), intent(in) :: array
            integer, dimension(4) :: max_loc
        end function
        module pure function maxloc_fp8_e5m2_1d_dim(array, dim) result(max_loc)
            type(fp8_e5m2), dimension(:), intent(in) :: array
            integer, intent(in) :: dim
            integer :: max_loc
        end function
        module pure function maxloc_fp8_e5m2_2d_dim(array, dim) result(max_loc)
            type(fp8_e5m2), dimension(:,:), intent(in) :: array
            integer, intent(in) :: dim
            integer, dimension(size(array, merge(2, 1, dim == 1))) :: max_loc
        end function
        module pure function maxloc_fp8_e5m2_3d_dim(array, dim) result(max_loc)
            type(fp8_e5m2), dimension(:,:,:), intent(in) :: array
            integer, intent(in) :: dim
            integer, dimension( size(array, merge(2, 1, dim == 1)), &
                & size(array, merge(2, 3, dim == 3))) :: max_loc
        end function
        module pure function maxloc_fp8_e5m2_4d_dim(array, dim) result(max_loc)
            type(fp8_e5m2), dimension(:,:,:,:), intent(in) :: array
            integer, intent(in) :: dim
            integer, dimension( size(array, merge(2, 1, dim == 1)), &
                & size(array, merge(3, 2, dim < 3)), &
    ...
    interface minloc
        module pure function minloc_fp8_e5m2_1d(array) result(min_loc)
            type(fp8_e5m2), dimension(:), intent(in) :: array
            integer :: min_loc
        end function
        module pure function minloc_fp8_e5m2_2d(array) result(min_loc)
            type(fp8_e5m2), dimension(:,:), intent(in) :: array
            integer, dimension(2) :: min_loc
        end function
        module pure function minloc_fp8_e5m2_3d(array) result(min_loc)
            type(fp8_e5m2), dimension(:,:,:), intent(in) :: array
            integer, dimension(3) :: min_loc
        end function
        module pure function minloc_fp8_e5m2_4d(array) result(min_loc)
            type(fp8_e5m2), dimension(:,:,:,:), intent(in) :: array
            integer, dimension(4) :: min_loc
        end function
        module pure function minloc_fp8_e5m2_1d_dim(array, dim) result(min_loc)
            type(fp8_e5m2), dimension(:), intent(in) :: array
            integer, intent(in) :: dim
            integer :: min_loc
        end function
        module pure function minloc_fp8_e5m2_2d_dim(array, dim) result(min_loc)
            type(fp8_e5m2), dimension(:,:), intent(in) :: array
            integer, intent(in) :: dim
            integer, dimension(size(array, merge(2, 1, dim == 1))) :: min_loc
        end function
        module pure function minloc_fp8_e5m2_3d_dim(array, dim) result(min_loc)
            type(fp8_e5m2), dimension(:,:,:), intent(in) :: array
            integer, intent(in) :: dim
            integer, dimension( size(array, merge(2, 1, dim == 1)), &
                & size(array, merge(2, 3, dim == 3))) :: min_loc
        end function
        module pure function minloc_fp8_e5m2_4d_dim(array, dim) result(min_loc)
            type(fp8_e5m2), dimension(:,:,:,:), intent(in) :: array
            integer, intent(in) :: dim
            integer, dimension( size(array, merge(2, 1, dim == 1)), &
                & size(array, merge(3, 2, dim < 3)), &
    ...
    ! C Interfaces
    INTERFACE
        PURE SUBROUTINE SET_FP8_E5M2_FROM_INT(OUT, IN) BIND(C, name = "__fp8_e5m2_helper_set_from_int")
            USE, INTRINSIC:: iso_c_binding
            INTEGER(c_int8_t), INTENT(OUT) :: OUT
            INTEGER(c_int), VALUE, INTENT(IN) :: IN
        END SUBROUTINE
        PURE SUBROUTINE SET_FP8_E5M2_FROM_REAL(OUT, IN) BIND(C, name = "__fp8_e5m2_helper_set_from_float")
            USE, INTRINSIC:: iso_c_binding
            INTEGER(c_int8_t), INTENT(OUT) :: OUT
            REAL(c_float), VALUE, INTENT(IN) :: IN
        END SUBROUTINE
        PURE SUBROUTINE SET_FP8_E5M2_FROM_DOUBLE(OUT, IN) BIND(C, name = "__fp8_e5m2_helper_set_from_double")
            USE, INTRINSIC:: iso_c_binding
            INTEGER(c_int8_t), INTENT(OUT) :: OUT
            REAL(c_double), VALUE, INTENT(IN) :: IN
        END SUBROUTINE
        PURE REAL(c_float) FUNCTION GET_FP8_E5M2(IN) BIND(C, name = "__fp8_e5m2_helper_get_float")
            USE, INTRINSIC :: iso_c_binding
            INTEGER(c_int8_t), INTENT(IN), VALUE :: IN
        END FUNCTION

        pure subroutine helper_add_fp8_e5m2_fp8_e5m2(out, a, b) bind(c, name = "__fp8_e5m2_helper_add_fp8_e5m2_fp8_e5m2")
            use, intrinsic :: iso_c_binding
            integer(c_int8_t), intent(out) :: out
            integer(c_int8_t), intent(in), value :: a
            integer(c_int8_t), intent(in), value :: b
        end subroutine
        pure subroutine helper_add_fp8_e5m2_real(out, a, b) bind(c, name = "__fp8_e5m2_helper_add_fp8_e5m2_real")
            use, intrinsic :: iso_c_binding
            integer(c_int8_t), intent(out) :: out
            integer(c_int8_t), intent(in), value :: a
        ...
        pure subroutine helper_mul_fp8_e5m2_fp8_e5m2(out, a, b) bind(c, name = "__fp8_e5m2_helper_mul_fp8_e5m2_fp8_e5m2")
            use, intrinsic :: iso_c_binding
            integer(c_int8_t), intent(out) :: out
            integer(c_int8_t), intent(in), value :: a
            integer(c_int8_t), intent(in), value :: b
        ...
        pure subroutine helper_mul_fp8_e5m2_real(out, a, b) bind(c, name = "__fp8_e5m2_helper_mul_fp8_e5m2_real")
            use, intrinsic :: iso_c_binding
            integer(c_int8_t), intent(out) :: out
            integer(c_int8_t), intent(in), value :: a
            real(c_float), intent(in), value :: b
        ...
        pure subroutine helper_sub_fp8_e5m2_real(out, a, b) bind(c, name = "__fp8_e5m2_helper_sub_fp8_e5m2_real")
            use, intrinsic :: iso_c_binding
            integer(c_int8_t), intent(out) :: out
            integer(c_int8_t), intent(in), value :: a
            real(c_float), intent(in), value :: b
        ...
        pure subroutine helper_sub_real_fp8_e5m2(out, a, b) bind(c, name = "__fp8_e5m2_helper_sub_real_fp8_e5m2")
            use, intrinsic :: iso_c_binding
            integer(c_int8_t), intent(out) :: out
        ...
        pure subroutine helper_unitary_minus_fp8_e5m2(out, a) bind(c, name = "__fp8_e5m2_helper_unitary_minus")
            use, intrinsic :: iso_c_binding
            integer(c_int8_t), intent(out) :: out
            integer(c_int8_t), intent(in), value :: a
        end subroutine
        ...
        pure subroutine helper_div_fp8_e5m2_fp8_e5m2(out, a, b) bind(c, name = "__fp8_e5m2_helper_div_fp8_e5m2_fp8_e5m2")
            use, intrinsic :: iso_c_binding
            integer(c_int8_t), intent(out) :: out
            integer(c_int8_t), intent(in), value :: a
            integer(c_int8_t), intent(in), value :: b
        ...
        pure subroutine helper_div_fp8_e5m2_real(out, a, b) bind(c, name = "__fp8_e5m2_helper_div_fp8_e5m2_real")
            use, intrinsic :: iso_c_binding
            integer(c_int8_t), intent(out) :: out
            integer(c_int8_t), intent(in), value :: a
            real(c_float), intent(in), value :: b
        ...
        pure subroutine helper_div_real_fp8_e5m2(out, a, b) bind(c, name = "__fp8_e5m2_helper_div_real_fp8_e5m2")
            use, intrinsic :: iso_c_binding
            integer(c_int8_t), intent(out) :: out
            real(c_float), intent(in), value :: a
            integer(c_int8_t), intent(in), value :: b
        ...
        pure subroutine helper_power_fp8_e5m2_real(out, a, b) bind(c, name = "__fp8_e5m2_helper_pow_fp8_e5m2_real")
            use, intrinsic :: iso_c_binding
            integer(c_int8_t), intent(out) :: out
            integer(c_int8_t), intent(in), value :: a
            real(c_float), intent(in), value :: b
        ...
        pure subroutine helper_power_fp8_e5m2_int(out, a, b) bind(c, name = "__fp8_e5m2_helper_pow_fp8_e5m2_int")
            use, intrinsic :: iso_c_binding
            integer(c_int8_t), intent(out) :: out
            integer(c_int8_t), intent(in), value :: a
...
CONTAINS
    ...
    elemental function construct_real(in) result(r)
        ...
        type(fp8_e5m2) :: r
        call SET_FP8_E5M2_FROM_REAL(r%value, in)
    end function

    elemental function construct_double(in) result(r)
        real(real64), intent(in) :: in
        type(fp8_e5m2) :: r
        call SET_FP8_E5M2_FROM_DOUBLE(r%value, in)
    end function
    ...
    elemental function construct_int32(in) result(r)
        ...
        call SET_FP8_E5M2_FROM_INT(r%value, tmp)
    end function
    ...
    elemental subroutine assign_int32(this, that)
        type(fp8_e5m2), intent(out) :: this
        integer(lpf_int32_kind), intent(in) :: that
        integer(c_int) :: tmp
        tmp = int(that, kind=c_int)
        call set_fp8_e5m2_from_int(this%value, tmp)
    end subroutine
    ...
    elemental subroutine assign_real(this, that)
        ...
        call set_fp8_e5m2_from_real(this%value, that)
    end subroutine

    elemental subroutine assign_double(this, that)
        type(fp8_e5m2), intent(out) :: this
        real(real64), intent(in) :: that
        call set_fp8_e5m2_from_double(this%value, that)
    end subroutine

    elemental subroutine assign_fp8_e5m2(this, that)
        type(fp8_e5m2), intent(out) :: this
    ...
    ! Operator(+)
    !
    elemental function add_fp8_e5m2_fp8_e5m2(this, that) result(sum)
        type(fp8_e5m2), intent(in) :: this
        type(fp8_e5m2), intent(in) :: that
        type(fp8_e5m2) :: sum

        call helper_add_fp8_e5m2_fp8_e5m2(sum%value, this%value, that%value)
    end function

    elemental function add_fp8_e5m2_real(this, that) result(sum)
        type(fp8_e5m2), intent(in) :: this
        real(real32), intent(in) :: that
        type(fp8_e5m2) :: sum
        call helper_add_fp8_e5m2_real(sum%value, this%value, that)
    end function

    elemental function add_real_fp8_e5m2(this, that) result(sum)
    ...
    ! Operator (-)
    !
    elemental function subtract_fp8_e5m2_fp8_e5m2(this, that) result(diff)
        type(fp8_e5m2), intent(in) :: this
        type(fp8_e5m2), intent(in) :: that
        type(fp8_e5m2) :: diff

        call helper_sub_fp8_e5m2_fp8_e5m2(diff%value, this%value, that%value)
    end function

    elemental function subtract_fp8_e5m2_real(this, that) result(diff)
        type(fp8_e5m2), intent(in) :: this
        real(real32), intent(in) :: that
        type(fp8_e5m2) :: diff

        call helper_sub_fp8_e5m2_real(diff%value, this%value, that)
    end function

    elemental function subtract_real_fp8_e5m2(this, that) result(diff)
        real(real32), intent(in) :: this
        type(fp8_e5m2), intent(in) :: that
        type(fp8_e5m2) :: diff
    ...
    elemental function unitary_minus_fp8_e5m2(this) result(out)
        ...
        call helper_unitary_minus_fp8_e5m2(out%value, this%value)
    end function

    !
    ! Operator(*)
    !
    elemental function multiply_fp8_e5m2_fp8_e5m2(this, that) result(prod)
        type(fp8_e5m2), intent(in) :: this
        type(fp8_e5m2), intent(in) :: that
        type(fp8_e5m2) :: prod

        call helper_mul_fp8_e5m2_fp8_e5m2(prod%value, this%value, that%value)
    end function

    elemental function multiply_fp8_e5m2_real(this, that) result(prod)
        type(fp8_e5m2), intent(in) :: this
        real(real32), intent(in) :: that
        type(fp8_e5m2) :: prod

        call helper_mul_fp8_e5m2_real(prod%value, this%value, that)
    end function

    elemental function multiply_real_fp8_e5m2(this, that) result(prod)
        real(real32), intent(in) :: this
        type(fp8_e5m2), intent(in) :: that
        type(fp8_e5m2) :: prod
    ...
    ! Operator(/)
    !
    elemental function divide_fp8_e5m2_fp8_e5m2(this, that) result(quot)
        type(fp8_e5m2), intent(in) :: this
        type(fp8_e5m2), intent(in) :: that
        type(fp8_e5m2) :: quot

        call helper_div_fp8_e5m2_fp8_e5m2(quot%value, this%value, that%value)
    end function

    elemental function divide_fp8_e5m2_real(this, that) result(quot)
        type(fp8_e5m2), intent(in) :: this
        real(real32), intent(in) :: that
        type(fp8_e5m2) :: quot
        call helper_div_fp8_e5m2_real(quot%value, this%value, that)
    end function

    elemental function divide_real_fp8_e5m2(this, that) result(quot)
        real(real32), intent(in) :: this
        type(fp8_e5m2), intent(in) :: that
        type(fp8_e5m2) :: quot
    ...
    ! Operator (.lt.)
    !
    elemental function lt_fp8_e5m2_fp8_e5m2(x, y) result(out)
        type(fp8_e5m2), intent(in)  :: x
        type(fp8_e5m2), intent(in) :: y
        logical :: out
    ...
    elemental function lt_fp8_e5m2_fp32(x, y) result(out)
        type(fp8_e5m2), intent(in)   :: x
    ...
    elemental function lt_fp32_fp8_e5m2(x, y) result(out)
        type(fp8_e5m2), intent(in)  :: y
    ...
    ! Operator (.le.)
    !
    elemental function le_fp8_e5m2_fp8_e5m2(x, y) result(out)
        type(fp8_e5m2), intent(in)  :: x
        type(fp8_e5m2), intent(in) :: y
        logical :: out
    ...
    elemental function le_fp8_e5m2_fp32(x, y) result(out)
        type(fp8_e5m2), intent(in)   :: x
        real(real32), intent(in) :: y
        logical :: out
    ...
    elemental function le_fp32_fp8_e5m2(x, y) result(out)
        type(fp8_e5m2), intent(in)  :: y
        real(real32), intent(in) :: x
        logical :: out
    ...
    ! Operator (.gt.)
    !
    elemental function gt_fp8_e5m2_fp8_e5m2(x, y) result(out)
        type(fp8_e5m2), intent(in)  :: x
        type(fp8_e5m2), intent(in) :: y
        logical :: out
    ...
    elemental function gt_fp8_e5m2_fp32(x, y) result(out)
        type(fp8_e5m2), intent(in)   :: x
        real(real32), intent(in) :: y
        logical :: out
    ...
    elemental function gt_fp32_fp8_e5m2(x, y) result(out)
        type(fp8_e5m2), intent(in)  :: y
        real(real32), intent(in) :: x
        logical :: out
    ...
    ! Operator (.ge.)
    !
    elemental function ge_fp8_e5m2_fp8_e5m2(x, y) result(out)
        type(fp8_e5m2), intent(in)  :: x
        type(fp8_e5m2), intent(in) :: y
        logical :: out
    ...
    elemental function ge_fp8_e5m2_fp32(x, y) result(out)
        type(fp8_e5m2), intent(in)   :: x
        real(real32), intent(in) :: y
        logical :: out
    ...
    elemental function ge_fp32_fp8_e5m2(x, y) result(out)
        type(fp8_e5m2), intent(in)  :: y
        real(real32), intent(in) :: x
        logical :: out
    ...
    ! Operator (.eq.)
    !
    elemental function eq_fp8_e5m2_fp8_e5m2(x, y) result(out)
        type(fp8_e5m2), intent(in)  :: x
        type(fp8_e5m2), intent(in) :: y
        logical :: out
    ...
    elemental function eq_fp8_e5m2_fp32(x, y) result(out)
        type(fp8_e5m2), intent(in)   :: x
        real(real32), intent(in) :: y
        logical :: out
    ...
    elemental function eq_fp32_fp8_e5m2(x, y) result(out)
        type(fp8_e5m2), intent(in)  :: y
        real(real32), intent(in) :: x
        logical :: out
    ...
    ! Operator (.ne.)
    !
    elemental function ne_fp8_e5m2_fp8_e5m2(x, y) result(out)
        type(fp8_e5m2), intent(in)  :: x
        type(fp8_e5m2), intent(in) :: y
        logical :: out
    ...
    elemental function ne_fp8_e5m2_fp32(x, y) result(out)
        type(fp8_e5m2), intent(in)   :: x
        real(real32), intent(in) :: y
        logical :: out
    ...
    elemental function ne_fp32_fp8_e5m2(x, y) result(out)
        type(fp8_e5m2), intent(in)  :: y
        real(real32), intent(in) :: x
        logical :: out
    ...
    ! Operator(**)
    !
    elemental function power_fp8_e5m2_fp8_e5m2(this, that) result(power)
        type(fp8_e5m2), intent(in) :: this
        type(fp8_e5m2), intent(in) :: that
        type(fp8_e5m2) :: power

        call helper_power_fp8_e5m2_fp8_e5m2(power%value, this%value, that%value)
    end function

    elemental function power_fp8_e5m2_real(this, that) result(power)
        type(fp8_e5m2), intent(in) :: this
        real(real32), intent(in) :: that
        type(fp8_e5m2) :: power

        call helper_power_fp8_e5m2_real(power%value, this%value, that)
    end function

    elemental function power_fp8_e5m2_int(this, that) result(power)
        type(fp8_e5m2), intent(in) :: this
    ...
    elemental function min3_fp8_e5m2(x, y, z) result(out)
        type(fp8_e5m2), intent(in) :: x, y, z
        type(fp8_e5m2) :: out
    ...
    elemental function max_fp8_e5m2(x, y) result(out)
        type(fp8_e5m2), intent(in) :: x, y
        type(fp8_e5m2) :: out
    ...
    elemental function max3_fp8_e5m2(x, y, z) result(out)
        type(fp8_e5m2), intent(in) :: x, y, z
        type(fp8_e5m2) :: out
    ...
    SUBROUTINE read_formatted(dtv, unit, iotype, v_list, iostat, iomsg)
        TYPE(FP8_E5M2), INTENT(INOUT) :: dtv
        INTEGER, INTENT(IN)      :: unit
        CHARACTER(*), INTENT(IN) :: iotype
        INTEGER, INTENT(IN)      :: v_list(:)
        INTEGER, INTENT(OUT)     :: iostat

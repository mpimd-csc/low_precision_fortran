...
submodule (lpf_fp8_e5m2) lpf_fp8_e5m2_maxloc
    use iso_c_binding
...
contains
    ...
    end function maxloc_fp8_e5m2_1d
    ...
    end function maxloc_fp8_e5m2_2d
    ...
    end function maxloc_fp8_e5m2_3d
    ...
    end function maxloc_fp8_e5m2_4d
    ...
    module pure function maxloc_fp8_e5m2_1d_dim(array, dim) result(max_loc)
        ...
        max_loc = maxloc_fp8_e5m2_1d(array)
    end function maxloc_fp8_e5m2_1d_dim
    ...
    end function maxloc_fp8_e5m2_2d_dim
    ...
    end function maxloc_fp8_e5m2_3d_dim
    ...
    end function maxloc_fp8_e5m2_4d_dim

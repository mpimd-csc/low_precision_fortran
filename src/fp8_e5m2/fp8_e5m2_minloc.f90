...
submodule (lpf_fp8_e5m2) lpf_fp8_e5m2_minloc
    use iso_c_binding
...
contains
    ...
    end function minloc_fp8_e5m2_2d
    ...
    end function minloc_fp8_e5m2_3d
    ...
    end function minloc_fp8_e5m2_4d
    ...
    module pure function minloc_fp8_e5m2_1d_dim(array, dim) result(min_loc)
        ...
        min_loc = minloc_fp8_e5m2_1d(array)
    end function minloc_fp8_e5m2_1d_dim
    ...
    end function minloc_fp8_e5m2_2d_dim
    ...
    end function minloc_fp8_e5m2_3d_dim
    ...
    end function minloc_fp8_e5m2_4d_dim

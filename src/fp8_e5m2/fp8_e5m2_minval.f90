...
submodule (lpf_fp8_e5m2) lpf_fp8_e5m2_minval
    use iso_c_binding
...
contains
    ...
    end function minval_fp8_e5m2_1d
    ...
    end function minval_fp8_e5m2_2d
    ...
    end function minval_fp8_e5m2_3d
    ...
    end function minval_fp8_e5m2_4d
    ...
    module pure function minval_fp8_e5m2_1d_dim(array, dim) result(min_value)
        ...
        min_value = minval_fp8_e5m2_1d(array)
    end function minval_fp8_e5m2_1d_dim
    ...
    end function minval_fp8_e5m2_2d_dim
    ...
    end function minval_fp8_e5m2_3d_dim
    ...
    end function minval_fp8_e5m2_4d_dim

...
/**
 * @brief Bfloat16 Symmetric Matrix-Vector Multiplication (BSYMV).
 *
 ...
 */
void LPF_GLOBAL(bsymv, BSYMV)(char* uplo, int64_t* n, lpf_bfloat16_t* alpha,
                              ...
                              int64_t* incy, lpf_fortran_strlen_t uplo_len)
{
    ...
    if (info != 0)
    {
        ...
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("BSYMV ", &infox,
...
void lpf_blas_bsymv_fortran_dyn_rank_64(char* uplo, int64_t* n,
                                        ...
                                        CFI_cdesc_t* _y, int64_t* incy)
{
    ...
    LPF_GLOBAL(bsymv, BSYMV)(uplo, n, (lpf_bfloat16_t*)alpha,
                             (lpf_bfloat16_t*)a, lda, (lpf_bfloat16_t*)x, incx,
                             (lpf_bfloat16_t*)beta, (lpf_bfloat16_t*)y, incy,
                             1);
}

void lpf_blas_bsymv_fortran_dyn_rank_32(char* uplo, int32_t* n,
                                        lpf_fbfloat16_t* alpha, CFI_cdesc_t* _a,
                                        ...
                                        CFI_cdesc_t* _y, int32_t* incy)
{
    ...
    int64_t _incx = *incx;
    int64_t _incy = *incy;
    LPF_GLOBAL(bsymv, BSYMV)(uplo, &_n, (lpf_bfloat16_t*)alpha,

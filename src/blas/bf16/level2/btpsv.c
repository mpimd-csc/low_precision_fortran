...
/* > */
/*  ===================================================================== */
void LPF_GLOBAL(btpsv,BTPSV)(char *uplo, char *trans, char *diag, lpf_blas_int_t *n,
        ...
        lpf_fortran_strlen_t diag_len)
{
    ...
    if (info != 0) {
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("BTPSV ", &info, (lpf_fortran_strlen_t)6);
        return;
    }
...
void lpf_blas_btpsv_fortran(char *uplo, char *trans, char *diag, lpf_blas_int_t *n,
...
void lpf_blas_btpsv_fortran_dyn_rank(char *uplo, char *trans, char *diag, lpf_blas_int_t *n,

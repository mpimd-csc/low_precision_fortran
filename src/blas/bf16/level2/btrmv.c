                              ...
                              lpf_fortran_strlen_t diag_len)
{
    ...
    if (info != 0)
    {
        ...
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("BTRMV ", &infox,
...
void lpf_blas_btrmv_fortran_dyn_rank_64(char* uplo, char* trans, char* diag,
                                        ...
                                        int64_t* incx)
{
    ...
    LPF_GLOBAL(btrmv, BTRMV)(uplo, trans, diag, n, (lpf_bfloat16_t*)a, lda,
                             (lpf_bfloat16_t*)x, incx, 1, 1, 1);
}

void lpf_blas_btrmv_fortran_dyn_rank_32(char* uplo, char* trans, char* diag,
                                        ...
                                        int32_t* incx)
{
    ...
    int64_t _lda = *lda;
    int64_t _incx = *incx;
    LPF_GLOBAL(btrmv, BTRMV)(uplo, trans, diag, &_n, (lpf_bfloat16_t*)a, &_lda,

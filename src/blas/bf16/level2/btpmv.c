        ...
        lpf_fortran_strlen_t diag_len)
{
    ...
    if (info != 0) {
        ...
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("BTPMV ", &infox, (lpf_fortran_strlen_t)6);
        return;
    }
...
void lpf_blas_btpmv_fortran_dyn_rank_64(char *uplo, char *trans, char *diag, int64_t *n,
...
void lpf_blas_btpmv_fortran_dyn_rank_32(char *uplo, char *trans, char *diag, int32_t *n,
        CFI_cdesc_t *_ap, CFI_cdesc_t *_x, int32_t *incx)
{
    ...
    int64_t _n = *n;
    int64_t _incx = *incx;
    LPF_GLOBAL(btpmv,BTPMV)(uplo, trans, diag, &_n,

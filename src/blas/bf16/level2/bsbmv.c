...
/*       SUBROUTINE BSBMV(UPLO,N,K,ALPHA,A,LDA,X,INCX,BETA,Y,INCY) */
...
/* > \verbatim */
/* > */
/* > BSBMV  performs the matrix-vector  operation */
/* > */
/* >    y := alpha*A*x + beta*y, */
/* > */
...
/* > */
/*  ===================================================================== */
void LPF_GLOBAL(bsbmv,BSBMV)(char *uplo, int64_t *n, int64_t *k, lpf_bfloat16_t *alpha,
        ...
        int64_t *incy, lpf_fortran_strlen_t uplo_len)
{
    ...
    if (info != 0) {
        int32_t infox = info ;
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("BSBMV ", &infox, (lpf_fortran_strlen_t)6);
        return;
    }
...
void lpf_blas_bsbmv_fortran_dyn_rank_64(char *uplo, int64_t *n, int64_t *k, lpf_fbfloat16_t *alpha,
...
void lpf_blas_bsbmv_fortran_dyn_rank_32(char *uplo, int32_t *n, int32_t *k, lpf_fbfloat16_t *alpha,

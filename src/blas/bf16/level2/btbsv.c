...
/**
 * @brief Bfloat16 Triangular Banded System Solve (BTBSV).
 *
                              ...
                              lpf_fortran_strlen_t diag_len)
{
    ...
    if (info != 0)
    {
        ...
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("BTBSV ", &infox,
...
void lpf_blas_btbsv_fortran_dyn_rank_64(char* uplo, char* trans, char* diag,
                                        ...
                                        int64_t* incx)
{
    ...
    LPF_GLOBAL(btbsv, BTBSV)(uplo, trans, diag, n, k, (lpf_bfloat16_t*)a, lda,
                             (lpf_bfloat16_t*)x, incx, 1, 1, 1);
}

void lpf_blas_btbsv_fortran_dyn_rank_32(char* uplo, char* trans, char* diag,
                                        ...
                                        int32_t* incx)
{
    ...
    int64_t _lda = *lda;
    int64_t _incx = *incx;
    LPF_GLOBAL(btbsv, BTBSV)(uplo, trans, diag, &_n, &_k, (lpf_bfloat16_t*)a,

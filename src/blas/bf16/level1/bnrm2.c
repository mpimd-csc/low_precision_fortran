...
lpf_fbfloat16_t lpf_blas_bnrm2_fortran_dyn_rank_64(int64_t* n, CFI_cdesc_t* _x,
                                                   int64_t* incx)
{
...
lpf_fbfloat16_t lpf_blas_bnrm2_fortran_dyn_rank_32(int32_t* n, CFI_cdesc_t* _x,
                                                   int32_t* incx)
{
    lpf_bfloat16_t* x = _x->base_addr;
    int64_t _n = *n;

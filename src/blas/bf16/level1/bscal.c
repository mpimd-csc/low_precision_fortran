...
/* > */
/*  ===================================================================== */
void LPF_GLOBAL(bscal,BSCAL)(lpf_blas_int_t *n, lpf_bfloat16_t *sa, lpf_bfloat16_t *sx, lpf_blas_int_t *incx)
{
 ...
 void lpf_blas_bscal_fortran(lpf_blas_int_t *n, lpf_fbfloat16_t *sa, lpf_fbfloat16_t *sx, lpf_blas_int_t *incx)
{

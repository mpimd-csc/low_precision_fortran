...
void lpf_blas_baxpby_fortran_dyn_rank_64(int64_t* n, lpf_fbfloat16_t* sa,
                                         CFI_cdesc_t* _sx, int64_t* incx,
                                         lpf_fbfloat16_t* sb, CFI_cdesc_t* _sy,
                                         int64_t* incy)
{
    lpf_bfloat16_t* sx = _sx->base_addr;
    lpf_bfloat16_t* sy = _sy->base_addr;
    LPF_GLOBAL(baxpby, BAXPBY)(n, (lpf_bfloat16_t*)sa, (lpf_bfloat16_t*)sx,
                               incx, (lpf_bfloat16_t*)sb, (lpf_bfloat16_t*)sy,
                               incy);
}

void lpf_blas_baxpby_fortran_dyn_rank_32(int32_t* n, lpf_fbfloat16_t* sa,
                                         ...
                                         int32_t* incy)
{
    ...
    int64_t _incx = *incx;
    int64_t _incy = *incy;
    LPF_GLOBAL(baxpby, BAXPBY)(&_n, (lpf_bfloat16_t*)sa, (lpf_bfloat16_t*)sx,
                               &_incx, (lpf_bfloat16_t*)sb, (lpf_bfloat16_t*)sy,
                               &_incy);
}

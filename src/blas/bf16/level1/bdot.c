...
lpf_fbfloat16_t lpf_blas_bdot_fortran_dyn_rank_64(int64_t* n, CFI_cdesc_t* _sx,
                                                  int64_t* incx,
                                                  CFI_cdesc_t* _sy,
                                                  int64_t* incy)
{
...
lpf_fbfloat16_t lpf_blas_bdot_fortran_dyn_rank_32(int32_t* n, CFI_cdesc_t* _sx,
                                                  int32_t* incx,
                                                  CFI_cdesc_t* _sy,
                                                  int32_t* incy)
{

...
/*       SUBROUTINE BROTMG(SD1,SD2,SX1,SY1,SPARAM) */
...
/*  ===================================================================== */
void LPF_GLOBAL(brotmg,BROTMG)(lpf_bfloat16_t *sd1, lpf_bfloat16_t *sd2, lpf_bfloat16_t *sx1, lpf_bfloat16_t *sy1, lpf_bfloat16_t
        *sparam)
{
    /* Initialized data */

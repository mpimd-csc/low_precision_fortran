...
void LPF_GLOBAL(baxpy,BAXPY)(lpf_blas_int_t *n, lpf_bfloat16_t *sa, lpf_bfloat16_t *sx, lpf_blas_int_t *incx,
        lpf_bfloat16_t *sy, lpf_blas_int_t *incy)
{
 ...
 void lpf_blas_baxpy_fortran( lpf_blas_int_t *n, lpf_fbfloat16_t *sa, lpf_fbfloat16_t *sx, lpf_blas_int_t *incx, lpf_fbfloat16_t *sy, lpf_blas_int_t * incy )
{

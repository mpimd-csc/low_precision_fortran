...
void lpf_blas_brotm_fortran_dyn_rank_64(int64_t* n, CFI_cdesc_t* _sx,
...
void lpf_blas_brotm_fortran_dyn_rank_32(int32_t* n, CFI_cdesc_t* _sx,
                                        ...
                                        int32_t* incy, CFI_cdesc_t* _sparam)
{
    ...
    int64_t _incx = *incx;
    int64_t _incy = *incy;
    LPF_GLOBAL(brotm, BROTM)(&_n, (lpf_bfloat16_t*)sx, &_incx,
                             (lpf_bfloat16_t*)sy, &_incy,
                             (lpf_bfloat16_t*)sparam);
}

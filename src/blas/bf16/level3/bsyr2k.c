                                ...
                                lpf_fortran_strlen_t trans_len)
{
    ...
    if (info != 0)
    {
        ...
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("BSYR2K", &infox,
...
void lpf_blas_bsyr2k_fortran_dyn_rank_64(char* uplo, char* trans, int64_t* n,
                                         ...
                                         int64_t* ldc)
{
    ...
    LPF_GLOBAL(bsyr2k, BSYR2K)(uplo, trans, n, k, (lpf_bfloat16_t*)alpha,
                               (lpf_bfloat16_t*)a, lda, (lpf_bfloat16_t*)b, ldb,
                               (lpf_bfloat16_t*)beta, (lpf_bfloat16_t*)c, ldc,
                               1, 1);
}

void lpf_blas_bsyr2k_fortran_dyn_rank_32(char* uplo, char* trans, int32_t* n,
                                         ...
                                         int32_t* ldc)
{
    ...
    int64_t _ldb = *ldb;
    int64_t _ldc = *ldc;
    LPF_GLOBAL(bsyr2k, BSYR2K)(uplo, trans, &_n, &_k, (lpf_bfloat16_t*)alpha,

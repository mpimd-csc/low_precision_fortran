...
/* > */
/*  ===================================================================== */
void LPF_GLOBAL(bsyr2k,BSYR2K)(char *uplo, char *trans, lpf_blas_int_t *n, lpf_blas_int_t *k,
        lpf_bfloat16_t *alpha, lpf_bfloat16_t *a, lpf_blas_int_t *lda, lpf_bfloat16_t *b, lpf_blas_int_t *ldb, lpf_bfloat16_t *beta,
        lpf_bfloat16_t *c__, lpf_blas_int_t *ldc, lpf_fortran_strlen_t uplo_len, lpf_fortran_strlen_t trans_len)
{
    ...
    if (info != 0) {
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("BSYR2K", &info, (lpf_fortran_strlen_t)6);
        return;
    }
...
void lpf_blas_bsyr2k_fortran(char *uplo, char *trans, lpf_blas_int_t *n, lpf_blas_int_t *k,
...
{
    LPF_GLOBAL(bsyr2k,BSYR2K)(uplo, trans, n, k,
...
void lpf_blas_bsyr2k_fortran_dyn_rank(char *uplo, char *trans, lpf_blas_int_t *n, lpf_blas_int_t *k,

...
/* > */
/*  ===================================================================== */
void LPF_GLOBAL(bgemm_fp32,BGEMM_FP32)(char *transa, char *transb, int64_t *m, int64_t *
...
void lpf_blas_bgemm_fp32_fortran_dyn_rank_64(char *transa, char *transb, int64_t *m, int64_t *
        n, int64_t *k, lpf_fbfloat16_t *alpha, CFI_cdesc_t *_a, int64_t *lda, CFI_cdesc_t *_b, int64_t *ldb, float *beta, CFI_cdesc_t *_c, int64_t *ldc)
{
...
void lpf_blas_bgemm_fp32_fortran_dyn_rank_32(char *transa, char *transb, int32_t *m, int32_t *
        n, int32_t *k, lpf_fbfloat16_t *alpha, CFI_cdesc_t *_a, int32_t *lda, CFI_cdesc_t *_b, int32_t *ldb, float *beta, CFI_cdesc_t *_c, int32_t *ldc)
{
    lpf_bfloat16_t *a = _a->base_addr;
    lpf_bfloat16_t *b = _b->base_addr;
    float *c = _c->base_addr;
    ...
    int64_t _ldb = *ldb;
    int64_t _ldc = *ldc;
    LPF_GLOBAL(bgemm_fp32,BGEMM_FP32)(transa, transb, &_m,

                              ...
                              lpf_fortran_strlen_t uplo_len)
{
    ...
    if (info != 0)
    {
        ...
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("BSYMM ", &infox,
...
void lpf_blas_bsymm_fortran_dyn_rank_64(char* side, char* uplo, int64_t* m,
                                        int64_t* n, lpf_fbfloat16_t* alpha,
                                        ...
                                        int64_t* ldc)
{
    ...
    LPF_GLOBAL(bsymm, BSYMM)(side, uplo, m, n, (lpf_bfloat16_t*)alpha,
                             (lpf_bfloat16_t*)a, lda, (lpf_bfloat16_t*)b, ldb,
                             (lpf_bfloat16_t*)beta, (lpf_bfloat16_t*)c, ldc, 1,
                             1);
}

void lpf_blas_bsymm_fortran_dyn_rank_32(char* side, char* uplo, int32_t* m,
                                        int32_t* n, lpf_fbfloat16_t* alpha,
                                        ...
                                        int32_t* ldc)
{
    ...
    int64_t _ldb = *ldb;
    int64_t _ldc = *ldc;
    LPF_GLOBAL(bsymm, BSYMM)(side, uplo, &_m, &_n, (lpf_bfloat16_t*)alpha,
                             (lpf_bfloat16_t*)a, &_lda, (lpf_bfloat16_t*)b,
                             &_ldb, (lpf_bfloat16_t*)beta, (lpf_bfloat16_t*)c,
                             &_ldc, 1, 1);
}

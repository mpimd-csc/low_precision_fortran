...
/* > */
/*  ===================================================================== */
void LPF_GLOBAL(bsymm,BSYMM)(char *side, char *uplo, int64_t *m, int64_t *n,
        lpf_bfloat16_t *alpha, lpf_bfloat16_t *a, int64_t *lda, lpf_bfloat16_t *b, int64_t *ldb, lpf_bfloat16_t *beta,
        lpf_bfloat16_t *c__, int64_t *ldc, lpf_fortran_strlen_t side_len, lpf_fortran_strlen_t uplo_len)
{
    ...
    if (info != 0) {
        ...
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("BSYMM ", &infox, (lpf_fortran_strlen_t)6);
        return;
    }
...
void lpf_blas_bsymm_fortran_dyn_rank_64(char *side, char *uplo, int64_t *m, int64_t *n,
        lpf_fbfloat16_t *alpha, CFI_cdesc_t *_a, int64_t *lda, CFI_cdesc_t *_b, int64_t *ldb, lpf_fbfloat16_t *beta,
...
void lpf_blas_bsymm_fortran_dyn_rank_32(char *side, char *uplo, int32_t *m, int32_t *n,
        lpf_fbfloat16_t *alpha, CFI_cdesc_t *_a, int32_t *lda, CFI_cdesc_t *_b, int32_t *ldb, lpf_fbfloat16_t *beta,
        CFI_cdesc_t *_c, int32_t *ldc)
{
    ...
    int64_t _ldb = *ldb;
    int64_t _ldc = *ldc;
    LPF_GLOBAL(bsymm,BSYMM)(side, uplo, &_m, &_n,
        (lpf_bfloat16_t *)alpha, (lpf_bfloat16_t *)a, &_lda, (lpf_bfloat16_t *)b, &_ldb, (lpf_bfloat16_t *)beta,

                                  ...
                                  lpf_fortran_strlen_t transb_len)
{
    ...
    if (info != 0)
    {
        ...
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("BGEMMTR", &infox,
...
void lpf_blas_bgemmtr_fortran_dyn_rank_64(
    char* uplo, char* transa, char* transb, int64_t* n, int64_t* k,
    lpf_fbfloat16_t* alpha, CFI_cdesc_t* _a, int64_t* lda, CFI_cdesc_t* _b,
    int64_t* ldb, lpf_fbfloat16_t* beta, CFI_cdesc_t* _c, int64_t* ldc)
{
    lpf_bfloat16_t* a = _a->base_addr;
    lpf_bfloat16_t* b = _b->base_addr;
    lpf_bfloat16_t* c = _c->base_addr;
    LPF_GLOBAL(bgemmtr, BGEMMTR)(
        uplo, transa, transb, n, k, (lpf_bfloat16_t*)alpha, (lpf_bfloat16_t*)a,
        lda, (lpf_bfloat16_t*)b, ldb, (lpf_bfloat16_t*)beta, (lpf_bfloat16_t*)c,
        ldc, 1, 1, 1);
}

void lpf_blas_bgemmtr_fortran_dyn_rank_32(
    char* uplo, char* transa, char* transb, int32_t* n, int32_t* k,
    lpf_fbfloat16_t* alpha, CFI_cdesc_t* _a, int32_t* lda, CFI_cdesc_t* _b,
    int32_t* ldb, lpf_fbfloat16_t* beta, CFI_cdesc_t* _c, int32_t* ldc)
{
    lpf_bfloat16_t* a = _a->base_addr;
    lpf_bfloat16_t* b = _b->base_addr;
    lpf_bfloat16_t* c = _c->base_addr;
    ...
    int64_t _ldc = *ldc;
    LPF_GLOBAL(bgemmtr, BGEMMTR)(
        uplo, transa, transb, &_n, &_k, (lpf_bfloat16_t*)alpha,
        (lpf_bfloat16_t*)a, &_lda, (lpf_bfloat16_t*)b, &_ldb,
        (lpf_bfloat16_t*)beta, (lpf_bfloat16_t*)c, &_ldc, 1, 1, 1);
}

...
/*       SUBROUTINE BTRMM(SIDE,UPLO,TRANSA,DIAG,M,N,ALPHA,A,LDA,B,LDB) */
...
/* > \verbatim */
/* > */
/* > BTRMM  performs one of the matrix-matrix operations */
/* > */
...
/* > */
/*  ===================================================================== */
void LPF_GLOBAL(btrmm,BTRMM)(char *side, char *uplo, char *transa, char *diag,
        int64_t *m, int64_t *n, lpf_bfloat16_t *alpha, lpf_bfloat16_t *a, int64_t *lda, lpf_bfloat16_t *b,
        ...
        lpf_fortran_strlen_t diag_len)
{
    ...
    if (info != 0) {
        ...
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("BTRMM ", &infox, (lpf_fortran_strlen_t)6);
        return;
    }
...
void lpf_blas_btrmm_fortran_dyn_rank_64(char *side, char *uplo, char *transa, char *diag,
        int64_t *m, int64_t *n, lpf_fbfloat16_t *alpha, CFI_cdesc_t *_a, int64_t *lda, CFI_cdesc_t *_b, int64_t *ldb)
{
    lpf_bfloat16_t *a = _a->base_addr;
    lpf_bfloat16_t *b = _b->base_addr;
    LPF_GLOBAL(btrmm,BTRMM)(side, uplo, transa, diag,
        m, n, (lpf_bfloat16_t *)alpha, (lpf_bfloat16_t *)a, lda, (lpf_bfloat16_t *)b,
        ldb, 1, 1, 1, 1);
}

void lpf_blas_btrmm_fortran_dyn_rank_32(char *side, char *uplo, char *transa, char *diag,
        int32_t *m, int32_t *n, lpf_fbfloat16_t *alpha, CFI_cdesc_t *_a, int32_t *lda, CFI_cdesc_t *_b, int32_t *ldb)
{
    lpf_bfloat16_t *a = _a->base_addr;
    lpf_bfloat16_t *b = _b->base_addr;
    int64_t _m = *m;
    ...
    int64_t _ldb = *ldb;
    LPF_GLOBAL(btrmm,BTRMM)(side, uplo, transa, diag,
        &_m, &_n, (lpf_bfloat16_t *)alpha, (lpf_bfloat16_t *)a, &_lda, (lpf_bfloat16_t *)b,
        &_ldb, 1, 1, 1, 1);
}

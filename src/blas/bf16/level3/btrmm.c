...
void LPF_GLOBAL(btrmm,BTRMM)(char *side, char *uplo, char *transa, char *diag,
        lpf_blas_int_t *m, lpf_blas_int_t *n, lpf_bfloat16_t *alpha, lpf_bfloat16_t *a, lpf_blas_int_t *lda, lpf_bfloat16_t *b,
        ...
        lpf_fortran_strlen_t diag_len)
{
    ...
    if (info != 0) {
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("BTRMM ", &info, (lpf_fortran_strlen_t)6);
        return;
    }
...
void lpf_blas_btrmm_fortran(char *side, char *uplo, char *transa, char *diag,
        lpf_blas_int_t *m, lpf_blas_int_t *n, lpf_fbfloat16_t *alpha, lpf_fbfloat16_t *a, lpf_blas_int_t *lda, lpf_fbfloat16_t *b,
        lpf_blas_int_t *ldb)
{
...
void lpf_blas_btrmm_fortran_dyn_rank(char *side, char *uplo, char *transa, char *diag,

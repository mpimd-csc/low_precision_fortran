    ...
    lpf_fortran_strlen_t transa_len, lpf_fortran_strlen_t diag_len)
{
    ...
    if (info != 0)
    {
        ...
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("BTRMM ", &infox,
...
void lpf_blas_btrmm_fortran_dyn_rank_64(char* side, char* uplo, char* transa,
                                        ...
                                        int64_t* ldb)
{
    ...
    LPF_GLOBAL(btrmm, BTRMM)(side, uplo, transa, diag, m, n,
                             (lpf_bfloat16_t*)alpha, (lpf_bfloat16_t*)a, lda,
                             (lpf_bfloat16_t*)b, ldb, 1, 1, 1, 1);
}

void lpf_blas_btrmm_fortran_dyn_rank_32(char* side, char* uplo, char* transa,
                                        ...
                                        int32_t* ldb)
{
    ...
    int64_t _lda = *lda;
    int64_t _ldb = *ldb;
    LPF_GLOBAL(btrmm, BTRMM)(side, uplo, transa, diag, &_m, &_n,

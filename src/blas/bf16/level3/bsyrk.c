...
void LPF_GLOBAL(bsyrk, BSYRK)(char* uplo, char* trans, int64_t* n, int64_t* k,
                              ...
                              int64_t* lda, lpf_bfloat16_t* beta,
                              lpf_bfloat16_t* c__, int64_t* ldc,
                              ...
                              lpf_fortran_strlen_t trans_len)
{
    ...
    if (info != 0)
    {
        ...
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("BSYRK ", &infox,
...
void lpf_blas_bsyrk_fortran_dyn_rank_64(char* uplo, char* trans, int64_t* n,
                                        int64_t* k, lpf_fbfloat16_t* alpha,
                                        CFI_cdesc_t* _a, int64_t* lda,
                                        lpf_fbfloat16_t* beta, CFI_cdesc_t* _c,
                                        int64_t* ldc)
{
    lpf_bfloat16_t* a = _a->base_addr;
    lpf_bfloat16_t* c = _c->base_addr;
    LPF_GLOBAL(bsyrk, BSYRK)(uplo, trans, n, k, (lpf_bfloat16_t*)alpha,
                             (lpf_bfloat16_t*)a, lda, (lpf_bfloat16_t*)beta,
                             (lpf_bfloat16_t*)c, ldc, 1, 1);
}

void lpf_blas_bsyrk_fortran_dyn_rank_32(char* uplo, char* trans, int32_t* n,
                                        int32_t* k, lpf_fbfloat16_t* alpha,
                                        ...
                                        int32_t* ldc)
{
    ...
    int64_t _lda = *lda;
    int64_t _ldc = *ldc;
    LPF_GLOBAL(bsyrk, BSYRK)(uplo, trans, &_n, &_k, (lpf_bfloat16_t*)alpha,
                             (lpf_bfloat16_t*)a, &_lda, (lpf_bfloat16_t*)beta,

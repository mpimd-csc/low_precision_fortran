...
/* > */
/*  ===================================================================== */
void LPF_GLOBAL(s2bcopy,S2BCOPY)(lpf_blas_int_t *n, float *sx, lpf_blas_int_t *incx, lpf_bfloat16_t *sy,
        lpf_blas_int_t *incy)
{
...
void lpf_blas_s2bcopy_fortran_dyn_rank(lpf_blas_int_t *n, float *sx, lpf_blas_int_t *incx, CFI_cdesc_t *_sy,
        lpf_blas_int_t *incy)
{

...
void LPF_GLOBAL(s2blacpy, S2BLACPY)(char* uplo, int64_t* m, int64_t* n,
                                    float* a, int64_t* lda, lpf_bfloat16_t* b,
...
void lpf_blas_s2blacpy_fortran_dyn_rank_64(char* uplo, int64_t* m, int64_t* n,
                                           float* a, int64_t* lda,
...
void lpf_blas_s2blacpy_fortran_dyn_rank_32(char* uplo, int32_t* m, int32_t* n,
                                           float* a, int32_t* lda,

...
void __lpf_blas_gemm_e5m2_fp32 (
        ...
        float alpha, fp8_e5m2_t *a, int64_t lda, fp8_e5m2_t *b, int64_t ldb,
        ...
        )
{
    ...
    cblas_gemm_e5m2e5m2f32(CblasColMajor, ctransa, ctransb,
            _m, _n, _k,
            alpha, (MKL_E5M2*) a, _lda, (MKL_E5M2*) b, _ldb,
            beta, c, _ldc);

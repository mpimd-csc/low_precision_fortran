...
void LPF_GLOBAL(hlacpy, HLACPY)(const char* uplo, int64_t* m, int64_t* n,
...
void lpf_blas_hlacpy_fortran_dyn_rank_64(char* uplo, int64_t* m, int64_t* n,
                                         CFI_cdesc_t* _a, int64_t* lda,
                                         CFI_cdesc_t* _b, int64_t* ldb)
{
    lpf_float16_t* a = _a->base_addr;
    lpf_float16_t* b = _b->base_addr;
    LPF_GLOBAL(hlacpy, HLACPY)(uplo, m, n, (lpf_float16_t*)a, lda,
                               (lpf_float16_t*)b, ldb, 1);
}

void lpf_blas_hlacpy_fortran_dyn_rank_32(char* uplo, int32_t* m, int32_t* n,
                                         ...
                                         CFI_cdesc_t* _b, int32_t* ldb)
{
    ...
    lpf_float16_t* a = _a->base_addr;
    lpf_float16_t* b = _b->base_addr;
    LPF_GLOBAL(hlacpy, HLACPY)(uplo, &_m, &_n, (lpf_float16_t*)a, &_lda,
                               (lpf_float16_t*)b, &_ldb, 1);
}

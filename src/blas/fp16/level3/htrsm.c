                              ...
                              lpf_fortran_strlen_t diag_len)
{
    ...
    {
        int32_t infox = info;
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("HTRSM ", &infox,
...
void lpf_blas_htrsm_fortran_dyn_rank_64(char* side, char* uplo, char* transa,
                                        ...
                                        int64_t* ldb)
{
    ...
    LPF_GLOBAL(htrsm, HTRSM)(side, uplo, transa, diag, m, n,
                             (lpf_float16_t*)alpha, (lpf_float16_t*)a, lda,
                             (lpf_float16_t*)b, ldb, 1, 1, 1, 1);
}

void lpf_blas_htrsm_fortran_dyn_rank_32(char* side, char* uplo, char* transa,
                                        ...
                                        int32_t* ldb)
{
    ...
    LPF_GLOBAL(htrsm, HTRSM)(side, uplo, transa, diag, &_m, &_n,

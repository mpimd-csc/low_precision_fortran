...
void LPF_GLOBAL(hgemm, HGEMM)(char* transa, char* transb, int64_t* m,
                              ...
                              int64_t* ldb, lpf_float16_t* beta,
                              ...
                              lpf_fortran_strlen_t transb_len)
{
    ...
    {
        int32_t infox = info;
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("HGEMM ", &infox,
    ...
    cblas_hgemm((CBLAS_LAYOUT)CblasColMajor, ta, tb, _m, _n, _k, malpha.i,
                (MKL_F16*)a, _lda, (MKL_F16*)b, _ldb, mbeta.i, (MKL_F16*)c__,
                _ldc);
...
void lpf_blas_hgemm_fortran_dyn_rank_64(char* transa, char* transb, int64_t* m,
                                        int64_t* n, int64_t* k,
                                        lpf_ffloat16_t* alpha, CFI_cdesc_t* _a,
                                        int64_t* lda, CFI_cdesc_t* _b,
                                        int64_t* ldb, lpf_ffloat16_t* beta,
                                        CFI_cdesc_t* _c, int64_t* ldc)
{
    ...
    LPF_GLOBAL(hgemm, HGEMM)(transa, transb, m, n, k, (lpf_float16_t*)alpha,
                             (lpf_float16_t*)a, lda, (lpf_float16_t*)b, ldb,
                             (lpf_float16_t*)beta, (lpf_float16_t*)c, ldc, 1,
                             1);
}

void lpf_blas_hgemm_fortran_dyn_rank_32(char* transa, char* transb, int32_t* m,
                                        int32_t* n, int32_t* k,
                                        lpf_ffloat16_t* alpha, CFI_cdesc_t* _a,
                                        int32_t* lda, CFI_cdesc_t* _b,
                                        int32_t* ldb, lpf_ffloat16_t* beta,
                                        CFI_cdesc_t* _c, int32_t* ldc)
{
    ...
    LPF_GLOBAL(hgemm, HGEMM)(transa, transb, &_m, &_n, &_k,
                             (lpf_float16_t*)alpha, (lpf_float16_t*)a, &_lda,
                             (lpf_float16_t*)b, &_ldb, (lpf_float16_t*)beta,

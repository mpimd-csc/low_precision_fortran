...
/* > */
/*  ===================================================================== */
void LPF_GLOBAL(hspmv,HSPMV)(char *uplo, lpf_blas_int_t *n, lpf_float16_t *alpha, lpf_float16_t *ap,
        lpf_float16_t *x, lpf_blas_int_t *incx, lpf_float16_t *beta, lpf_float16_t *y, lpf_blas_int_t *incy, lpf_fortran_strlen_t
        uplo_len)
{
    ...
    if (info != 0) {
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("HSPMV ", &info, (lpf_fortran_strlen_t)6);
        return;
    }
...
void lpf_blas_hspmv_fortran(char *uplo, lpf_blas_int_t *n, lpf_ffloat16_t *alpha, lpf_ffloat16_t *ap,
        lpf_ffloat16_t *x, lpf_blas_int_t *incx, lpf_ffloat16_t *beta, lpf_ffloat16_t *y, lpf_blas_int_t *incy)
{
    LPF_GLOBAL(hspmv,HSPMV)(uplo, n, (lpf_float16_t *)alpha, (lpf_float16_t *)ap,

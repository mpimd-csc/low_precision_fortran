...
/* > */
/*  ===================================================================== */
void LPF_GLOBAL(htbmv,HTBMV)(char *uplo, char *trans, char *diag, int64_t *n,
        ...
        uplo_len, lpf_fortran_strlen_t trans_len, lpf_fortran_strlen_t diag_len)
{
    ...
    if (info != 0) {
        int32_t infox = info;
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("HTBMV ", &infox, (lpf_fortran_strlen_t)6);
        return;
    }
...
void lpf_blas_htbmv_fortran_dyn_rank_64(char *uplo, char *trans, char *diag, int64_t *n,
...
void lpf_blas_htbmv_fortran_dyn_rank_32(char *uplo, char *trans, char *diag, int32_t *n,
        int32_t *k, CFI_cdesc_t *a, int32_t *lda, CFI_cdesc_t *x, int32_t *incx)
{
    ...
    LPF_GLOBAL(htbmv,HTBMV)(uplo, trans, diag, &_n,

...
/* > */
/*  ===================================================================== */
void LPF_GLOBAL(hsyr2,HSYR2)(char *uplo, int64_t *n, lpf_float16_t *alpha, lpf_float16_t *x,
        int64_t *incx, lpf_float16_t *y, int64_t *incy, lpf_float16_t *a, int64_t *lda, lpf_fortran_strlen_t
        uplo_len)
{
    ...
    if (info != 0) {
        int32_t infox = info;
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("HSYR2 ", &infox, (lpf_fortran_strlen_t)6);
        return;
    }
...
void lpf_blas_hsyr2_fortran_dyn_rank_64(char *uplo, int64_t *n, lpf_ffloat16_t *alpha, CFI_cdesc_t *x,
...
void lpf_blas_hsyr2_fortran_dyn_rank_32(char *uplo, int32_t *n, lpf_ffloat16_t *alpha, CFI_cdesc_t *x,
        int32_t *incx, CFI_cdesc_t *y, int32_t *incy, CFI_cdesc_t *a, int32_t *lda)
{
    ...
    LPF_GLOBAL(hsyr2,HSYR2)(uplo, &_n, (lpf_float16_t *)alpha, (lpf_float16_t *)x_ptr,
        &_incx, (lpf_float16_t *)y_ptr, &_incy, (lpf_float16_t *)a_ptr, &_lda, 1);
}

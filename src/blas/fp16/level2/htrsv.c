...
void LPF_GLOBAL(htrsv, HTRSV)(char* uplo, char* trans, char* diag, int64_t* n,
                              ...
                              lpf_fortran_strlen_t diag_len)
{
    ...
    {
        int32_t infox = info;
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("HTRSV ", &infox,
...
void lpf_blas_htrsv_fortran_dyn_rank_64(char* uplo, char* trans, char* diag,
                                        ...
                                        int64_t* incx)
{
    ...
    LPF_GLOBAL(htrsv, HTRSV)(uplo, trans, diag, n, (lpf_float16_t*)a_ptr, lda,
                             (lpf_float16_t*)x_ptr, incx, 1, 1, 1);
}

void lpf_blas_htrsv_fortran_dyn_rank_32(char* uplo, char* trans, char* diag,
                                        ...
                                        int32_t* incx)
{
    ...
    LPF_GLOBAL(htrsv, HTRSV)(uplo, trans, diag, &_n, (lpf_float16_t*)a_ptr,

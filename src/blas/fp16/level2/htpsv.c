...
void LPF_GLOBAL(htpsv, HTPSV)(char* uplo, char* trans, char* diag, int64_t* n,
                              ...
                              lpf_fortran_strlen_t diag_len)
{
    ...
    {
        int32_t infox = info;
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("HTPSV ", &infox,
...
void lpf_blas_htpsv_fortran_dyn_rank_64(char* uplo, char* trans, char* diag,
                                        int64_t* n, CFI_cdesc_t* ap,
                                        CFI_cdesc_t* x, int64_t* incx)
{
    lpf_float16_t* ap_ptr = ap->base_addr;
    lpf_float16_t* x_ptr = x->base_addr;

    LPF_GLOBAL(htpsv, HTPSV)(uplo, trans, diag, n, (lpf_float16_t*)ap_ptr,
                             (lpf_float16_t*)x_ptr, incx, 1, 1, 1);
}

void lpf_blas_htpsv_fortran_dyn_rank_32(char* uplo, char* trans, char* diag,
                                        int32_t* n, CFI_cdesc_t* ap,
                                        CFI_cdesc_t* x, int32_t* incx)
{
    ...
    LPF_GLOBAL(htpsv, HTPSV)(uplo, trans, diag, &_n, (lpf_float16_t*)ap_ptr,
                             (lpf_float16_t*)x_ptr, &_incx, 1, 1, 1);
}

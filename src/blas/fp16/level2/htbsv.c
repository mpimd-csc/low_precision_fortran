...
/*       SUBROUTINE HTBSV(UPLO,TRANS,DIAG,N,K,A,LDA,X,INCX) */
...
/* > \verbatim */
/* > */
/* > HTBSV  solves one of the systems of equations */
/* > */
/* >    A*x = b,   or   A**T*x = b, */
/* > */
...
void LPF_GLOBAL(htbsv,HTBSV)(char *uplo, char *trans, char *diag, int64_t *n,
        int64_t *k, lpf_float16_t *a, int64_t *lda, lpf_float16_t *x, int64_t *incx, lpf_fortran_strlen_t
        uplo_len, lpf_fortran_strlen_t trans_len, lpf_fortran_strlen_t diag_len)
{
    ...
    if (info != 0) {
        int32_t infox = info;
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("HTBSV ", &infox, (lpf_fortran_strlen_t)6);
        return ;
    }
...
void lpf_blas_htbsv_fortran_dyn_rank_64(char *uplo, char *trans, char *diag, int64_t *n,
        int64_t *k, CFI_cdesc_t *a, int64_t *lda, CFI_cdesc_t *x, int64_t *incx)
{
...
void lpf_blas_htbsv_fortran_dyn_rank_32(char *uplo, char *trans, char *diag, int32_t *n,
        int32_t *k, CFI_cdesc_t *a, int32_t *lda, CFI_cdesc_t *x, int32_t *incx)
{
    lpf_float16_t *a_ptr = a->base_addr;
    lpf_float16_t *x_ptr = x->base_addr;
    int64_t _n = *n;
    ...
    LPF_GLOBAL(htbsv,HTBSV)(uplo, trans, diag, &_n,
        &_k, (lpf_float16_t *)a_ptr, &_lda, (lpf_float16_t *)x_ptr, &_incx, 1, 1, 1);
}

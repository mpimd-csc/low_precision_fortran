...
/* > */
/*  ===================================================================== */
void LPF_GLOBAL(htbsv,HTBSV)(char *uplo, char *trans, char *diag, lpf_blas_int_t *n,
        ...
        uplo_len, lpf_fortran_strlen_t trans_len, lpf_fortran_strlen_t diag_len)
{
    ...
    if (info != 0) {
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("HTBSV ", &info, (lpf_fortran_strlen_t)6);
        return ;
    }
...
void lpf_blas_htbsv_fortran(char *uplo, char *trans, char *diag, lpf_blas_int_t *n,

...
/* > */
/*  ===================================================================== */
void LPF_GLOBAL(hsbmv,HSBMV)(char *uplo, lpf_blas_int_t *n, lpf_blas_int_t *k, lpf_float16_t *alpha,
        ...
        lpf_blas_int_t *incy, lpf_fortran_strlen_t uplo_len)
{
    ...
    if (info != 0) {
        LPF_GLOBAL(lpf_blas_xerbla, LPF_BLAS_XERBLA)("HSBMV ", &info, (lpf_fortran_strlen_t)6);
        return;
    }
...
void lpf_blas_hsbmv_fortran(char *uplo, lpf_blas_int_t *n, lpf_blas_int_t *k, lpf_ffloat16_t *alpha,
...
void lpf_blas_hsbmv_fortran_dyn_rank(char *uplo, lpf_blas_int_t *n, lpf_blas_int_t *k, lpf_ffloat16_t *alpha,

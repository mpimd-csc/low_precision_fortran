...
/**
 * @brief Half-precision AXPY operation.
 *
 ...
 */
void LPF_GLOBAL(haxpy, HAXPY)(int64_t* n, lpf_float16_t* sa, lpf_float16_t* sx,
                              int64_t* incx, lpf_float16_t* sy, int64_t* incy)
{
...
void lpf_blas_haxpy_fortran_dyn_rank_64(int64_t* n, lpf_ffloat16_t* sa,
                                        CFI_cdesc_t* _sx, int64_t* incx,
                                        CFI_cdesc_t* _sy, int64_t* incy)
{
    lpf_float16_t* sx = _sx->base_addr;
    lpf_float16_t* sy = _sy->base_addr;
    LPF_GLOBAL(haxpy, HAXPY)(n, (lpf_float16_t*)sa, (lpf_float16_t*)sx, incx,
                             (lpf_float16_t*)sy, incy);
}

void lpf_blas_haxpy_fortran_dyn_rank_32(int32_t* n, lpf_ffloat16_t* sa,
                                        ...
                                        CFI_cdesc_t* _sy, int32_t* incy)
{
    ...
    int64_t _incx = *incx;
    int64_t _incy = *incy;
    LPF_GLOBAL(haxpy, HAXPY)(&_n, (lpf_float16_t*)sa, (lpf_float16_t*)sx,
                             &_incx, (lpf_float16_t*)sy, &_incy);
}

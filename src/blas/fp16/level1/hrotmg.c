...
/*       SUBROUTINE HROTMG(SD1,SD2,SX1,SY1,SPARAM) */
...
/*  ===================================================================== */
void LPF_GLOBAL(hrotmg,HROTMG)(lpf_float16_t *sd1, lpf_float16_t *sd2, lpf_float16_t *sx1, lpf_float16_t *sy1, lpf_float16_t
        *sparam)
{
    /* Initialized data */
...
void lpf_blas_hrotmg_fortran_dyn_rank(
        lpf_ffloat16_t *sd1, lpf_ffloat16_t *sd2, lpf_ffloat16_t *sx1, lpf_ffloat16_t *sy1,
        CFI_cdesc_t *_sparam)
{

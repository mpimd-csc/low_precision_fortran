...
/* > */
/*  ===================================================================== */
void LPF_GLOBAL(hswap,HSWAP)(lpf_blas_int_t *n, lpf_float16_t *sx, lpf_blas_int_t *incx, lpf_float16_t *sy,
        lpf_blas_int_t *incy)
{
 ...
 void lpf_blas_hswap_fortran(lpf_blas_int_t * n, lpf_ffloat16_t *sx, lpf_blas_int_t *incx, lpf_ffloat16_t *sy,
        lpf_blas_int_t *incy)
{

    ...
    module recursive subroutine potrf2( uplo, n, a, lda, info )
        ...
        if( n.eq.1 ) then
            ...
            if( upper ) then
                ...
                !
                call htrsm( 'l', 'u', 't', 'n', n1, n2, one, a( 1, 1 ), lda, a( 1, n1+1 ), lda )
                !
                !           update and factor a22
                !
                call hsyrk( uplo, 't', n2, n1, -one, a( 1, n1+1 ), lda, one, a( n1+1, n1+1 ), lda )
                ...
                !
                call htrsm( 'r', 'l', 't', 'n', n2, n1, one, a( 1, 1 ), lda, a( n1+1, 1 ), lda )
                !
                !           update and factor a22
                !
                call hsyrk( uplo, 'n', n2, n1, -one, a( n1+1, 1 ), lda, one, a( n1+1, n1+1 ), lda )
                call potrf2( uplo, n2, a( n1+1, n1+1 ), lda, iinfo )
                if ( iinfo.ne.0 ) then
                    info = iinfo + n1
                    return

submodule(lpf_lapack_fp16) lpf_lapack_ormqr_fp16
...
contains
    ...
    module subroutine ormqr( side, trans, m, n, k, a, lda, tau, c, ldc, work, lwork, info )
        ...
        if( nb.lt.nbmin .or. nb.ge.k ) then
            ...
            !        use unblocked code
            !
            call orm2r( side, trans, m, n, k, a, lda, tau, c, ldc,        &
                &                work,                                             &
                &                iinfo )
        else
            !
            ...
            do  i = i1, i2, i3
                ...
                !
                call larft( 'forward', 'columnwise', nq-i+1, ib, a( i, i ),                                           &
                ...
                !           apply h or h**t
                !
                call larfb( side, trans, 'forward', 'columnwise', mi,  ni,                                            &

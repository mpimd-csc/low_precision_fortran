submodule(lpf_lapack_fp16) lpf_lapack_geqrt3v_fp16
contains
    ...
    module recursive subroutine geqrt3v( norm, m, n, a, lda, diagr, t, ldt, info )
      ...
      character(len=*), intent(in)  :: norm
        ...
        if( n.eq.1 ) then
            ...
            !
            call geqrt3v( norm, m, n1, a, lda, diagr, t, ldt, iinfo )
            !
            ...
            call htrmm( 'l', 'l', 't', 'non-unit', n1, n2, one,                   &
                &               a, lda, t( 1, j1 ), ldt )
            !
            ...
            !
            call htrmm( 'l', 'l', 'n', 'non-unit', n1, n2, one,                   &
                &               a, lda, t( 1, j1 ), ldt )
            !
            do j=1,n2
                do i=1,n1
            ...
            !
            call geqrt3v( norm, m-n1, n2, a( j1, j1 ), lda, diagr(j1),                     &
                &                t( j1, j1 ), ldt, iinfo )
            !
            ...
            !
            call htrmm( 'r', 'l', 'n', 'non-unit', n1, n2, one,                   &

submodule(lpf_lapack_fp16) lpf_lapack_gemqrtv_fp16
...
contains
    ...
    module subroutine gemqrtv( side, trans, m, n, k, nb, v, ldv, t, ldt,     &
            ...
            !
            if( info.ne.0 ) then
                call lpf_blas_xerbla( 'gemqrtv', -info )
                return
            end if
            !
            ...
            if( left .and. tran ) then
                ...
                do i = 1, k, nb
                    ib = min( nb, k-i+1 )
                    call larfbv( 'l', 't', 'f', 'c', m-i+1, n, ib,              &
                        &                   v( i, i ), ldv, t( 1, i ), ldt,                &
                ...
                do i = 1, k, nb
                    ib = min( nb, k-i+1 )
                    call larfbv( 'r', 'n', 'f', 'c', m, n-i+1, ib,              &
                        &                   v( i, i ), ldv, t( 1, i ), ldt,                &
                ...
                do i = kf, 1, -nb
                    ib = min( nb, k-i+1 )
                    call larfbv( 'l', 'n', 'f', 'c', m-i+1, n, ib,              &
                        &                   v( i, i ), ldv, t( 1, i ), ldt,                &
                        &                   c( i, 1 ), ldc, work, ldwork )
                end do
                !
                ...
                do i = kf, 1, -nb
                    ib = min( nb, k-i+1 )
                    call larfbv( 'r', 't', 'f', 'c', m, n-i+1, ib,              &
                        &                   v( i, i ), ldv, t( 1, i ), ldt,                &
                        &                   c( 1, i ), ldc, work, ldwork )
                end do
                !

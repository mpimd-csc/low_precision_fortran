submodule (lpf_lapack_fp16) lpf_lapack_larfb_fp16
contains
    ...
    !>
    !  =====================================================================
    module subroutine larfb( side, trans, direct, storev, m, n, k, v, ldv, t, ldt, c, ldc, work, ldwork ) bind(c, name="hlarfb_")
        ...
        if( lsame( storev, 'c' ) ) then
            ...
            if( lsame( direct, 'f' ) ) then
                ...
                if( lsame( side, 'l' ) ) then
                    ...
                    !          w := w * v1
                    !
                    call htrmm( 'right', 'lower', 'no transpose', 'unit', n, k, one, v, ldv, work, ldwork )
                    if( m.gt.k ) then
                        !
                        !             w := w + c2**t * v2
                        !
                    ...
                    !          w := w * v1**t
                    !
                    call htrmm( 'right', 'lower', 'transpose', 'unit', n, k, one, v, ldv, work, ldwork )
                    !
                    !          c1 := c1 - w**t
                    !
                    do j = 1, k
                    ...
                    !          w := w * v1
                    !
                    call htrmm( 'right', 'lower', 'no transpose', 'unit', m, k, one, v, ldv, work, ldwork )
                    if( n.gt.k ) then
                        !
                        !             w := w + c2 * v2
                        !
                    ...
                    !          w := w * v1**t
                    !
                    call htrmm( 'right', 'lower', 'transpose', 'unit', m, k, one, v, ldv, work, ldwork )
                    !
                    !          c1 := c1 - w
                    !
                    do j = 1, k
                ...
                if( lsame( side, 'l' ) ) then
                    ...
                    !          w := w * v2
                    !
                    call htrmm( 'right', 'upper', 'no transpose', 'unit', n, k, one, v( m-k+1, 1 ), ldv, work, ldwork )
                    if( m.gt.k ) then
                        !
                        !             w := w + c1**t * v1
                        !
                    ...
                    !          w := w * v2**t
                    !
                    call htrmm( 'right', 'upper', 'transpose', 'unit', n, k, one, v( m-k+1, 1 ), ldv, work, ldwork )
                    !
                    !          c2 := c2 - w**t
                    !
                    do j = 1, k
                    ...
                    !          w := w * v2
                    !
                    call htrmm( 'right', 'upper', 'no transpose', 'unit', m, k, one, v( n-k+1, 1 ), ldv, work, ldwork )
                    if( n.gt.k ) then
                        !
                        !             w := w + c1 * v1
                        !
                    ...
                    !          w := w * v2**t
                    !
                    call htrmm( 'right', 'upper', 'transpose', 'unit', m, k, one, v( n-k+1, 1 ), ldv, work, ldwork )
                    !
                    !          c2 := c2 - w
                    !
                    do j = 1, k
            ...
            if( lsame( direct, 'f' ) ) then
                ...
                if( lsame( side, 'l' ) ) then
                    ...
                    !          w := w * v1**t
                    !
                    call htrmm( 'right', 'upper', 'transpose', 'unit', n, k, one, v, ldv, work, ldwork )
                    if( m.gt.k ) then
                        !
                        !             w := w + c2**t * v2**t
                        !
                    ...
                    !          w := w * v1
                    !
                    call htrmm( 'right', 'upper', 'no transpose', 'unit', n, k, one, v, ldv, work, ldwork )
                    !
                    !          c1 := c1 - w**t
                    !
                    do j = 1, k
                    ...
                    !          w := w * v1**t
                    !
                    call htrmm( 'right', 'upper', 'transpose', 'unit', m, k, one, v, ldv, work, ldwork )
                    if( n.gt.k ) then
                        !
                        !             w := w + c2 * v2**t
                        !
                    ...
                    !          w := w * v1
                    !
                    call htrmm( 'right', 'upper', 'no transpose', 'unit', m, k, one, v, ldv, work, ldwork )
                    !
                    !          c1 := c1 - w
                    !
                    do j = 1, k
                ...
                if( lsame( side, 'l' ) ) then
                    ...
                    !          w := w * v2**t
                    !
                    call htrmm( 'right', 'lower', 'transpose', 'unit', n, k, one, v( 1, m-k+1 ), ldv, work, ldwork )
                    if( m.gt.k ) then
                        !
                        !             w := w + c1**t * v1**t
                        !
                    ...
                    !          w := w * v2
                    !
                    call htrmm( 'right', 'lower', 'no transpose', 'unit', n, k, one, v( 1, m-k+1 ), ldv, work, ldwork )
                    !
                    !          c2 := c2 - w**t
                    !
                    do j = 1, k
                    ...
                    !          w := w * v2**t
                    !
                    call htrmm( 'right', 'lower', 'transpose', 'unit', m, k, one, v( 1, n-k+1 ), ldv, work, ldwork )
                    if( n.gt.k ) then
                        !
                        !             w := w + c1 * v1**t
                        !
                    ...
                    !          w := w * v2
                    !
                    call htrmm( 'right', 'lower', 'no transpose', 'unit', m, k, one, v( 1, n-k+1 ), ldv, work, ldwork )
                    !
                    !          c1 := c1 - w
                    !
                    do j = 1, k

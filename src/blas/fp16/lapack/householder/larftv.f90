submodule (lpf_lapack_fp16) lpf_lapack_larftv_fp16
contains
    ...
    module recursive subroutine larftv( direct, storev, n, k, v, ldv, tau, t, ldt ) bind(c, name="hlarftv_")
        ...
        if(qr) then
            ...
            !
            call larftv(direct, storev, n, l, v, ldv, tau, t, ldt)
            !
            !        compute t_{2,2} recursively
            !
            call larftv(direct, storev, n-l, k-l, v(l+1, l+1), ldv, tau(l+1), t(l+1, l+1), ldt)
            !
            !        compute t_{1,2}
            !        t_{1,2} = v_{2,1}'
            !
            ...
            !
            call htrmm('right', 'lower', 'no transpose', 'non-unit', l, k-l, one, v(l+1, l+1), ldv, t(1, l+1), ldt)
            ...
            !        t_{1,2} = t_{1,2}*v_{2,2}'
            !
            call htrmm('right', 'upper', 'transpose', 'non-unit', l, k-l, one, v(l+1, l+1), ldv, t(1, l+1), ldt)
            ...
            !        compute t_{1,1} recursively
            !
            call larftv(direct, storev, n-l, k-l, v, ldv, tau, t, ldt)
            !
            !        compute t_{2,2} recursively
            !
            call larftv(direct, storev, n, l, v(1, k-l+1), ldv, tau(k-l+1), t(k-l+1, k-l+1), ldt)
            !
            !        compute t_{2,1}
            !        t_{2,1} = v_{2,2}'
            !
            ...
            !
            call htrmm('right', 'upper', 'no transpose', 'non-unit', l, k-l, one, v(n-k+1, 1), ldv, t(k-l+1, 1), ldt)
            ...
            !        compute t_{2,2} recursively
            !
            call larftv(direct, storev, n, l, v(k-l+1, 1), ldv,            &
            ...
            !
            call htrmm('right', 'lower', 'transpose', 'non-unit', l, k-l,      &

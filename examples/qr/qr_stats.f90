...
contains
    ...
    subroutine print_qr_stats( st )
        ...
        write(*, '( I7, " | ", I7, " | ", ES20.13, " | ", ES20.13, " | ", F20.5)') st%m, st%n, st%reconstruct_err, &
            & st%orth_err, st%walltime
    end subroutine

    subroutine print_qr_stats_header()
     write(*, '( A7, " | ", A7, " | ", A20, " | ", A20, " | ", A20)') "M", "N", "||A-QR||_2 rel.", "||Q**TQ-I||_2", " Time [s]"
     write(*, '( A7, "-|-", A7, "-|-", A20, "-|-", A20, "-|-", A20)') "--------", "--------", "------------------------", &
         & "-----------------------", "-----------------------------"

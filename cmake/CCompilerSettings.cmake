...
FUNCTION(ADD_C_COMPILER_FLAG_REQUIRED VAR FLAGNAME )
    IF(DEFINED CACHE{C_${VAR}_${FLAGNAME}_WORK})
        RETURN()
    ENDIF()
    SET(_SAVE ${CMAKE_REQUIRED_QUIET})
    ...
    IF ( _WORKS)
        ...
        MESSAGE(STATUS "C compiler supports ${FLAGNAME}")
    ELSE()
        MESSAGE(FATAL_ERROR "C compiler does not support ${FLAGNAME}")
    ENDIF()
    SET(CMAKE_REQUIRED_QUIET ${_SAVE})
ENDFUNCTION()
...
IF(CMAKE_C_COMPILER_ID STREQUAL "GNU")
    ...
    IF(LPF_INTEGER8 STREQUAL ON)
        ADD_DEFINITIONS(-DLPF_INTEGER8)
    ENDIF()
...
ELSEIF(CMAKE_C_COMPILER_ID STREQUAL "NVHPC")
    # Nvidia HPC SDK (nvc)
    SET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Mnoipa --diag_suppress bad_pp_directive_keyword")
    SET(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} -O3")
...
ELSEIF(CMAKE_C_COMPILER_ID STREQUAL "XL")
    # IBM XLC
    SET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -qmaxmem=32768")
    IF(HOSTOPT STREQUAL ON)
